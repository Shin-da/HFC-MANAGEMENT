...
if (isset($_GET['productcode'])) {
    ...
    $query = "SELECT p.*, pl.productimage FROM products p JOIN products pl ON p.productcode = pl.productcode WHERE p.productcode = ?";
    $stmt = $conn->prepare($query);
            ...
            <?php if ($product): ?>
                ...
                <div class="product-details">
                    ...
                    <div class="product-info">
                        ...
                        <p>Product Price: <?php echo htmlspecialchars($product['unit_price']); ?></p>
                    </div>
                </div>
            <?php else: ?>
