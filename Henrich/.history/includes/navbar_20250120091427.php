<nav class="top">
    ...
    <div class="nav-right">
        <ul class="nav-actions">
            <?php
            // Update notification query to match existing table structure
            ...
            <li class="nav-item notification-dropdown">
                <button class="nav-button" id="notification-btn" aria-label="Notifications">
                    <i class='bx bx-bell'></i>
                    <?php if ($notif_count > 0): ?>
                        <span class="badge"><?php echo $notif_count ?></span>
                    <?php endif; ?>
                </button>
                <div class="dropdown-content notifications-menu">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const notificationDropdown = notificationBtn.closest('.notification-dropdown');
    ...
    notificationDropdown.querySelector('.dropdown-content').addEventListener('click', (e) => {
        e.stopPropagation();
    });
});
</script>
