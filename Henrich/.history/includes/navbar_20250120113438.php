<?php
// Keep using the existing database connection
// Remove the added database connection code

// Initialize notifications array
$notifications = [];
$notif_count = 0;

// Only try to fetch notifications if we have a valid connection and user is logged in
    ...
    <div class="navbar-content">
        ...
        <div class="navbar-items">
            ...
            <div class="user-profile">
                <img src="/assets/images/profile-default.jpg" alt="Profile">
