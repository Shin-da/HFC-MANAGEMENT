...
<body>
                ...
                <?php foreach ($categories as $categoryName => $products) : ?>
                    <div class="category">
                        ...
                        <div class="carousel" id="<?php echo $categoryName; ?>">
                            ...
                            <a class="see-more" onclick="toggleSeeMore('<?php echo $categoryName; ?>')">See More</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
    ...
    function toggleSeeMore(categoryId) {
        var carousel = document.getElementById(categoryId);
        var seeMoreButton = carousel.querySelector('.see-more');
        var isExpanded = seeMoreButton.textContent === 'See Less';
        var products = carousel.querySelectorAll('.carousel-item');
        var productSection = carousel.parentNode; /* get the product-section element */
