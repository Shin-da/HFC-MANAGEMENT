    ...
    <section class=" panel">
                    ...
                    <table id="inventorybatchdetails">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="quantity[]" id="quantity<?= $i ?>" placeholder="Quantity">
                                <input type="number" name="weight[]" id="weight<?= $i ?>" placeholder="Weight">
                                <input type="number" name="price[]" id="price<?= $i ?>" placeholder="Price">
        ...
        <script>
            ...
            function addTableRow() {
                ...
                cell3.innerHTML = "<select name='productcode[]' id='productcode' oninput='fetchProductInfo()'><option value=''></option> </select>"; 
