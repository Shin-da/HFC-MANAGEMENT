               ...
               <div class="overview">
                    <div class="alertbox"><!-- Alerts -->
                         <div class="content-header">
                              ...
                              <?php
                              $alerts = $conn->query("SELECT COUNT(*) FROM inventory WHERE onhand <= 5")->fetch_row()[0] + $conn->query("SELECT COUNT(*) FROM inventory WHERE onhand <= 10")->fetch_row()[0];
                              ?>
                              <span class="number"> <?php echo $alerts; ?> </span>
                         </div>
                         <?php
                         $sql = "SELECT productcode, productdescription, onhand FROM inventory ORDER BY onhand ASC";
