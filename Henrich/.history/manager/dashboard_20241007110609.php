          ...
          <div class="right-panel">
               <div class="overview">
                    <div class="alertbox"><!-- Alerts -->
                         ...
                         <?php
                         $sql = "SELECT productcode, productdescription, onhand FROM inventory WHERE onhand <= 10 ORDER BY onhand ASC";
                         ...
                         <?php
                              ...
                              ?>
                                        <div class="alertbox-content <?php echo $color; ?>">
                                             <div class="alert">
                                                  <p> <?php echo $row['productcode']; ?> - <?php echo $row['productdescription']; ?> has <?php echo $row['onhand']; ?> items left.</p>
                                             </div>
                                        </div>
                                   <?php
                                   }
