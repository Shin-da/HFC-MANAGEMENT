...
$stmt->bind_param("siiisssi", $batchid, $productcode, $quantity, $weight, $price, $_SESSION['username'], date('Y-m-d H:i:s'));
if (!$stmt->execute()) {
...
$stmt->bind_param("siiiiii", $ibdid, $batchid, $productcode, $quantity, $weight, $price);
if (!$stmt->execute()) {
    echo "Error inserting data: " . $stmt->error;
    exit;
}
...
/******  2971b75e-2226-40c1-97fd-13665e19b530  *******/