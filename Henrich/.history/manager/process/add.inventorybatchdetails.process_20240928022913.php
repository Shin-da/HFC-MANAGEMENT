...
$stmt = $conn->prepare("INSERT INTO inventorybatchdetails where $ibdid, $batchid, $productcode, $quantity, $weight, $price (ibdid, batchid, productcode, quantity, weight, price) VALUES (?, ?, ?, ?, ?, ?)");
