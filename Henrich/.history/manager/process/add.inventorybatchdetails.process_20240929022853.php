...
$sql = $conn->prepare(" INSERT INTO inventorybatchdetails (ibdid, batchid, productcode, quantity, weight, price , dateupdated) VALUES (?, ?, ?, ?, ?, ?, ?)");
$sql->bind_param("iisiiis", $ibdid, $batchid, $productcode, $quantity, $weight, $price, $dateupdated);
