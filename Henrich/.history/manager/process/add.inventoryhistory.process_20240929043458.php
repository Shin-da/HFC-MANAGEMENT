...
$stmt = $conn->prepare("INSERT INTO inventoryhistory (batchid, productcode, totalquantity, totalweight, totalprice, dateencoded) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("iiiiiis", $batchid, $productcode, $sumQuantity, $sumWeight, $sumPrice, $dateEncoded);
if (!$stmt->execute()) {
