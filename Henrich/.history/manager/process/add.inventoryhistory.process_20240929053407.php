...
// Calculate total boxes, total weight, and total cost using stored arrays
$totalboxes = array_sum($_POST['quantity']);
$totalweight = array_sum($_POST['weight']);
$totalcost = array_sum($_POST['price']);
