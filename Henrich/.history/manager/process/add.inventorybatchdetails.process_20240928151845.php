...
$stmt = $conn->prepare("INSERT INTO inventoryhistory (batchid, dateofarrival, encoder, description, datestockin, datestockout, total_cost) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isssssd", $batchid, $dateofarrival, $encoder, $description, $datestockin, $datestockout, $total_cost);
$stmt->execute();
