...
$stmt = $conn->prepare("INSERT INTO inventoryhistory (batchid, dateofarrival, encoder, description, date_stock_in, date_stock_out, total_cost) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("isssssd", $batchid, $dateofarrival, $encoder, $description, $date_stock_in, $date_stock_out, $total_cost);
$stmt->execute();
