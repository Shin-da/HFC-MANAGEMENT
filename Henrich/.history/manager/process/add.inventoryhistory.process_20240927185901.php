...
$stmt = $conn->prepare(inventoryhistory (batchid, dateofarrival, encoder, dateencoded, description, datestockin, datestockout, totalboxes, totalweight, totalcost) VALUES ('$batchid', '$dateofarrival', '$encoder', '$dateencoded', '$description', '$datestockin', '$datestockout', '$totalboxes', '$totalweight', '$totalcost')";
for ($i = 0; $i < count($); $i++) {
    $batchid = $batchid[$i];
