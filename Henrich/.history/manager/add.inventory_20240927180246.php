...
/*************  ✨ Codeium Command 🌟  *************/
                                    ...
                                    <td><input type="date" name="dateUpdated[]" placeholder="Date Updated"></td>
                                    <td><button type="button" class="btn btn-danger" onclick="deleteTableRow(this)">X</button></td>
/******  fafb4fa1-79ce-4447-8ac6-8948c51f29b9  *******/
                                </tr>
                            <?php endfor; ?>
                        </tbody>
        ...
        function addTableRow() {
            ...
            cell1.innerHTML = "<input type='text' name='iid[]' placeholder='Inventory ID'>";
            cell2.innerHTML = "<input type='text' name='productcode[]' placeholder='Product Code'>";
            cell3.innerHTML = "<input type='text' name='productdescription[]' placeholder='Product Description'>";
            cell4.innerHTML = "<input type='text' name='category[]' placeholder='Category'>";
            cell5.innerHTML = "<input type='number' name='onhand[]' placeholder='On Hand'>";
            cell6.innerHTML = "<input type='date' name='dateupdated[]' placeholder='Date Updated'>";
