<?php require '../reusable/redirect404.php'; require '../session/session.php'; include "../database/dbconnect.php"; ?>
<!DOCTYPE html>
<html>
     ...
     <section class="dashboard panel">  <!-- === Dashboard === -->
               ...
               <div class="overview ">
                    <div class="panel-content top-products">
                         ...
                         <div class="product-ranking"><!-- === Top Products === -->
                              <p> DITO YUNG RANKING NG PRODUCTS </p>
                         </div>
                    </div>
               </div>
          </div>
          ...
          <div class="right-panel">
               ...
               <div class="overview">
                    ...
                    <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4751.096598776257!2d121.05962867592767!3d14.352104486105427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d0b49ee1db09%3A0x50ba65f05e4b96ec!2sRobinsons%20Galleria%20South!5e1!3m2!1sen!2sph!4v1727590740558!5m2!1sen!2sph" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
