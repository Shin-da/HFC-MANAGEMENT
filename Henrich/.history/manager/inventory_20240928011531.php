  ...
  <section class=" panel">
    ...
    <div class="container-fluid">
      <div class="table-header">
        ...
        <span>
          <a href="add.inventoryhistory.php" class="btn btn-primary">
    ...
    <div class="container-fluid">
      <div class="table-header">
        <div class="title">
          ...
          <h3>Batch Details (displaying  only)</h3>
        </div>
        <span>
      ...
      <div class="container-fluid">
        <table class="table" id="myTable">
          ...
          <tbody>
            ...
            ?>
CREATE TABLE inventorybatchdetails (
    ibdid INT PRIMARY KEY AUTO_INCREMENT,
    batchid INT, 
    productcode VARCHAR(50), 
    quantity INT,
    weight FLOAT,
    price DECIMAL(10, 2),
    FOREIGN KEY (batch_id) REFERENCES inventoryhistory(batch_id)
);

-- Inserting sample data
INSERT INTO inventorybatchdetails (batch_id, product_code, quantity, weight, price)
VALUES
    (1, 'P001', 100, 50, 10000.00),
    (1, 'P002', 50, 50, 10000.00),
    (2, 'P003', 80, 40, 12000.00),
    (2, 'P004', 40, 40, 6000.00),
    (3, 'P005', 60, 60, 15000.00);
