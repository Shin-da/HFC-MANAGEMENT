                ...
                <form action="./process/add.stockmovement.process.php" method="POST">
                    <table id="inventorybatchdetails">
                        ...
                        <tbody>
                            ...
                            <tr>
/*************  ✨ Codeium Command 🌟  *************/
                                <td><input type="input" name="ibdid[]" id="ibdid<?= $i ?>" placeholder="IBD ID" value="<?php
...
/******  01a605e1-669b-4a55-bc23-7dfa5af45664  *******/
                                <td><input type="text" name="batchid[]" id="batchid<?= $i ?>" placeholder="Batch ID" value="<?php
