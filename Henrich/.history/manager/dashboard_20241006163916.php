...
/*************  ✨ Codeium Command 🌟  *************/
                    <div class="alertbox"><!-- Alerts -->
                         ...
                         <div class="alerts">
                         <?php
                         $items = $conn->query("SELECT * FROM inventory WHERE onhand < 10");
                         if ($items->num_rows > 0) {
                             echo '<div class="alertbox-content warning">';
                             echo '<div class="alert">';
                             echo '<i class="bx bx-error-circle"></i><span> Stock Alert! </span>';
                             echo '<p>Low stock on:</p><ul>';
                             while ($row = $items->fetch_assoc()) {
                                 echo '<li>' . $row['productdescription'] . ' - ' . $row['onhand'] . ' items left</li>';
                             }
                             echo '</ul>';
                             echo '</div>';
                             echo '</div>';
...
/******  a05823f1-d2b6-4008-86c3-88684bf63163  *******/
