    ...
    <div class="container-fluid">
      ...
      <div class="table-header">
        ...
        <div class="search-box">
          ...
          <input type="text" id="generalsearch" onkeyup="search()"
            placeholder="Search...">
        </div>
      </div>
...
<script>
  ...
  function generalSearch() {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      if (iidCell.includes(filter) || productcodeCell.includes(filter) || productdescriptionCell.includes(filter) || categoryCell.includes(filter) || onhandCell.includes(filter) || dateupdatedCell.includes(filter)) {
        match = true;
      }
  ...
  document.getElementById("general-search").addEventListener("input", generalSearch);
</script>
