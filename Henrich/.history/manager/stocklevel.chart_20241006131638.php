    ...
    data: {
        ...
        datasets: [{
         ...
         backgroundColor: function(context) {
             ...
             var gradientColor = getGradientColor(randomColor, context); // apply gradient effect to the random color
...
function getGradientColor(color, context) {
    ...
    var barWidth = context.chart.width / context.chart.data.datasets[0].data.length;
    var barX = context.dataIndex * barWidth;
    var gradientAlphaValue = 0.5 + (gradientAlphaStep * (barX / context.chart.width));
    return gradientColor + "," + gradientAlphaValue + ")";
}
</script>

/******  b8d8fedc-9826-4bd9-9cf7-c361e27afde9  *******/