...
<body>
  ...
  <section class=" panel">
    ...
    <div class="container-fluid">
      ...
      <?php
      $in = "SELECT * FROM inventoryhistory LIMIT 10"; // We only want to display 10 items for now
    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        <table class="table" id="myTable">
          ...
          <tbody>
            <?php
            $inventoryBatchDetailsTableSQL = "SELECT * FROM inventorybatchdetail LIMIT 10"; // We only want to display 10 items for now
