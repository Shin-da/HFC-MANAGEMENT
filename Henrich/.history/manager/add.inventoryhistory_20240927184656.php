                    ...
                    <table id="inventoryhistory">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="date" name="dateofarrival[]" value="" /></td>
                                <td><input type="text" name="encoder[]" value="" /></td>
                                <td><input type="date" name="dateencoded[]" value="" /></td>
                                <td><input type="text" name="description[]" value="" /></td>
                                <td><input type="date" name="datestockin[]" value="" /></td>
                                <td><input type="date" name="datestockout[]" value="" /></td>
                                <td><input type="text" name="totalboxes[]" value="" /></td>
                                <td><input type="text" name="totalweight[]" value="" /></td>
                            </tr>
                        <?php endfor; ?>
                        </tbody>
