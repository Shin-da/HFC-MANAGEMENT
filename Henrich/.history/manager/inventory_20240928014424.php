  ...
  <section class=" panel">
    ...
    <div class="container-fluid">
      <div class="table-header">
        ...
        <span>
          <a href="add.inventorybatchdetails.php" class="btn btn-primary">
            <i class="bx bx-plus"></i>
            Add To Inventory
          </a>
        </span>
      ...
      <?php
      $inventoryBatchDetailsTableSQL = "SELECT * FROM inventorybatchdetails LIMIT 10"; // We only want to display 10 items for now

      if ($conn->connect_error) {
      die("Connection failed: " . $conn->connect_error);
      }

      $sql = $inventoryBatchDetailsTableSQL;
      $result = $conn->query($sql);
      ?>
      <div class="container-fluid">
        <table class="table" id="myTable">
