...
/*************  ✨ Codeium Command 🌟  *************/
                                ...
                                $batchids = array();
                                while ($row = $result->fetch_assoc()) {
                                    array_push($batchids, $row['batchid']);
                                }
                                $nextBatchid = "BM" . str_pad(count($batchids) + 1, 4, '0', STR_PAD_LEFT);
                                echo "BM" . str_pad(count($batchids) + 1, 4, '0', STR_PAD_LEFT);

                                ?>
/******  9f3cc9b6-49da-467f-ac07-3074958007e0  *******/

                                <td><input type="input" name="ibdid[]" id="ibdid<?= $i ?>" placeholder="IBD ID" value="<?= $lastid ?>" disabled></td>

                                <td><input type="text" name="batchid[]" id="batchid<?= $i ?>" placeholder="Batch ID" value="<?= $>" disabled></td>
                                <td>
        ...
        <script>
            ...
            function addTableRow() {
                ...
                cell1.innerHTML = `<input type="input" name="ibdid[]" id="ibdid${table.rows.length - 1}" placeholder="IBD ID">`;
