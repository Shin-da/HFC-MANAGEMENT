        ...
        <div class="container-fluid" style="overflow-x:Scroll;">
          ...
          <table class="table" id="myTable">
            <thead>
              ...
              <tr class="">
                <td  style="padding: 0;"><input type="text" placeholder="Search ID" id="iid-filter" onkeyup="filterTable()"></td>
...
<script> // script for filtering table results based on user input
