...
<body>
    ...
    <section class=" panel"><!-- === stock_activity_log === -->
        ...
        $query = "SELECT * FROM stockactivitylog";
        ...
        <div class="container-fluid">
            ...
            <?php
            $StockActivityLogTableSQL = "SELECT * FROM stockactivitylog LIMIT 10"; // We only want to display 10 items for now

            if ($conn->connect_error) {
                die("Connection failed: " . $conn->connect_error);
            }

            $sql = $StockActivityLogTableSQL;
