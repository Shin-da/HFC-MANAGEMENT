      ...
      <div class="container-fluid">
        ...
        <table class="table" id="myTable">
          <thead>
            ...
            <tr>
              <td><input type="text" placeholder="Search I" id="iid-filter" onkeyup="filterTable()"></td>
              <td><input type="text" placeholder="Search" id="productcode-filter" onkeyup="filterTable()"></td>
              <td><input type="text" placeholder="Search" id="productdescription-filter" onkeyup="filterTable()"></td>
              <td><input type="text" placeholder="Search" id="category-filter" onkeyup="filterTable()"></td>
              <td><input type="text" placeholder="Search" id="onhand-filter" onkeyup="filterTable()"></td>
              <td><input type="text" placeholder="Search" id="dateupdated-filter" onkeyup="filterTable()"></td>
            </tr>
          </thead>
