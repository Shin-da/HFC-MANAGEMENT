...
<canvas id="stock-chart" style="width: 100%; height: 300px; border-radius: 10px; "></canvas>

<!-- Include the Chart.js library -->
<script src="https://cdn.jsdelivar.net/npm/chart.js@3.7.1/dist/chart.min.js"></script>
