...
/*************  ✨ Codeium Command 🌟  *************/
        ...
        <script>
            ...
            function addTableRow() {
                ...
                cell1.innerHTML = "<input type='hidden' name='ibdid[]' value='" + (table.rows.length - 1) + "'>";
                ...
                cell3.innerHTML = "<input type='number' name='quantity[]' id='quantity' placeholder='Quantity'>";
                cell4.innerHTML = "<input type='number' name='weight[]' id='weight' placeholder='Weight'>";
                cell5.innerHTML = "<input type='number' name='price[]' id='price' placeholder='Price'>";
                cell6.innerHTML = "<button type='button' class='btn btn-danger' onclick='deleteRow(this)'>X</button>";
/******  8b6d0ee1-74cb-4562-b091-2fdddb0a6879  *******/
            }
        </script>
    </section>
