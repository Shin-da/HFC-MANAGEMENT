...
<body>
  ...
  if ($items->num_rows > 0) {
    echo '<div style="position: absolute; right: 0; top: 50px; background-color: #ff9800; padding: 10px; border-radius: 5px;">';
...
/*************  ✨ Codeium Command 🌟  *************/
      <div class="table-header">
        <div class="title">
          ...
          <span><h2>INVENTORY Stock Management (display only) </h2> </span>
          
        </div>
      </div>
/******  b48637a8-d394-4718-a54f-5604e270d27d  *******/
