...
-                var sql = "SELECT MONTH(DateTime) as Month, SUM(Quantity) as Sales FROM tblorders GROUP BY MONTH(Order_DateTime) ORDER BY Month ASC";
                 $.ajax({
...
<<<<<<<  e98e1535-953c-4a5b-afc7-79bb52e9152c  >>>>>>>