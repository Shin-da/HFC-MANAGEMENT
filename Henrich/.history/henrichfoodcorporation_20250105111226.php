...
if ($categoryResult->num_rows > 0) {
    while ($categoryRow = $categoryResult->fetch_assoc()) {
        $categoryName = $categoryRow['productcategory'];
        $sql = "SELECT productcode, productname, productweight, productprice, productcategory, productimage FROM productlist WHERE productcategory = '$categoryName'";
        $productResult = $conn->query($sql);
        $categories[$categoryName] = array();
        if ($productResult->num_rows > 0) {
            while ($productRow = $productResult->fetch_assoc()) {
                $categories[$categoryName][] = $productRow;
            }
        ...
        <section class="products">
            <?php foreach ($categories as $categoryName => $products) : ?>
                <div class="category">
                    ...
                    <div class="carousel slide" data-ride="carousel" data-interval="3000" id="<?php echo $categoryName; ?>">
...
/******  2e264eac-8df8-4dc1-b3be-d6c6681e5268  *******/