            ...
            <ul class="nano-content">
                ...
                <li class="sub-menu <?php if ($current_page == 'sales' || $current_page == 'transactions' || $current_page == 'orderhistory'    || $current_page == 'returns') echo 'active'; ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php if ($current_page == 'transactions') echo 'active'; ?>"><a href="orders.php"> <i class="bx bxs-right-arrow sub-arrow<?php if ($current_page == 'orders') echo 'active'; ?>"></i> Transactions</a></li>
