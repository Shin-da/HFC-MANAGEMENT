            ...
            <ul class="nano-content">
                ...
                <li class="sub-menu <?php if ($current_page == 'sales' || $current_page == 'orders' || $current_page == 'orderhistory'    || $current_page == 'returns') echo 'active'; ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php if ($current_page == 'ordered') echo 'active'; ?>"><a href="orderedproducts.php"> <i class="bx bxs-right-arrow sub-arrow<?php if ($current_page == 'orderedproducts') echo 'active'; ?>"></i> Ordered Products</a></li>
