<nav class="sidebar close hidden open" id="sidebar">
    <header class="sidebar-header">
        <div class="logo-details">
            <img src="../resources/images/henrichlogo.png" alt="henrich logo">
            <span class="logo-name">Henrich</span>
        </div>
        <div class="user-info">
    ...
    <div class="menu-wrapper">
        <ul class="nav-links">
            ...
            <!-- Sales Menu -->
            <li class="menu-item has-submenu <?php if (in_array($current_page, ['sales', 'orderedproducts', 'customerorder', 'returns'])) echo 'active open'; ?>">
