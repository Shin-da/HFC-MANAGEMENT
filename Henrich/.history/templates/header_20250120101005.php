...
<head>
    ...
    <!-- Toast notifications -->
    {% comment %} <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css"> {% endcomment %}
...
<body class="<?php echo Page::getBodyClass(); ?>">
    <?php 
    // Include existing sidebar and navbar components from Henrich/includes
