        ...
        <?php while ($user = $users->fetch_assoc()): ?>
            <div class="user-card animate-in" data-role="<?= $user['role'] ?>" data-status="<?= $user['status'] ?>">
                ...
                <div class="user-info">
                    ...
                    <p><i class="fas fa-user"></i> <?= htmlspecialchars($user['username'] ?? '') ?></p>
                    <p><i class="fas fa-envelope"></i> <?= htmlspecialchars($user['useremail'] ?? '') ?></p>
                    <p><i class="fas fa-user-tag"></i> <?= ucfirst(htmlspecialchars($user['role'] ?? '')) ?></p>
                    <?php if (!empty($user['department'])): ?>
                        <p><i class="fas fa-building"></i> <?= htmlspecialchars($user['department']) ?></p>
                    <?php endif; ?>
                </div>
