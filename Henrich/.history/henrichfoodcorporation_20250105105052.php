...
$sql = "SELECT productimage FROM productlist WHERE productcode = ?";
...
if ($result->num_rows > 0) {
    ...
    echo json_encode(['productimage' => $row['productimage']]);
} else {
    echo json_encode(['productimage' => 'default.jpg']);
}
...
/******  85621f8d-b0eb-4ca6-b992-71b00fa740ff  *******/
