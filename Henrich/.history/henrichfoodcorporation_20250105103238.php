...
$sql = "SELECT productcode, productname, productweight, unit_price, productcategory FROM productlist";
                ...
                <?php foreach ($categories as $category => $products) : ?>
                    <?php foreach ($products as $product) : ?>
                        <li>
                            ...
                            <p><?php echo $product['productweight'] ?>g - <?php echo $product['unit_price'] ?> PHP</p>
                        </li>
                    <?php endforeach; ?>
                <?php endforeach; ?>
            </ul>
