...
<?php
  ...
  if ($outOfStockItems->num_rows > 0) {
    ...
    echo '<span class="close" onclick="setTimeout(function(){this.parentElement.style.display = \'block\'}, 3000)"><i class="bx bx-x"></i></span>';
...
<script>
  setTimeout(function() {
    document.querySelector('.out-of-stock-alert').style.display = 'block';
    document.querySelector('.alert').style.display = 'block';
  }, 3000);
</script>


/******  7a5219bd-b59c-412c-8790-9feef692b897  *******/