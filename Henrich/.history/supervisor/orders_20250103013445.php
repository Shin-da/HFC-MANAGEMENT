...
/*************  ✨ Codeium Command 🌟  *************/
            <div class="table-header" style="background-color: #ffc107;">
            <div class="table-header">
                <div class="title">
                    <span>
                        <h2>Orders </h2>
                    </span>
                    <span style="font-size: 12px; color: var(--purple-color);">Recent Customer Orders (Online and Walk-in)</span>
                </div>
                <div class="title">
                    <span style="color: var(--purple-color);"><?php echo date('l, F jS') ?></span>
                </div>
            </div>
/******  309902af-8cde-40c9-9989-1c789510d64f  *******/
