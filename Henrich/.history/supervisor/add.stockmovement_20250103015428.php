            ...
            <div class="container-fluid" style="overflow-y: scroll">
                ...
                <form action="./process/add.stockmovement.process.php" method="POST">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" name="batchid" id="<?= $batchid; ?>" value="<?= $batchid; ?>" readonly required></td>
                    ...
                    <div class="searchbar">
                        <input type="text" id="search" placeholder="Search product code or name">
...
/******  317ab84a-6cc2-4921-b609-67ea60842e72  *******/