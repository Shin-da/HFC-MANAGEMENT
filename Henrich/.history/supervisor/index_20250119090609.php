...
// Modified low stock query using inventory table
$sql = "
    SELECT 
        p.productcode,
        p.productname,
    ...
    WHERE i.availablequantity < 5 AND i.availablequantity > 0
";
...
$dashboard_data = [
    'metrics' => $conn->query("
        SELECT 
            ...
            (SELECT COUNT(*) FROM customerorder 
             WHERE ordertype = 'Delivery' AND DATE(orderdate) = CURRENT_DATE) as today_online_orders,
            (SELECT COALESCE(SUM(ordertotal), 0) FROM customerorder 
             WHERE ordertype = 'Delivery' AND DATE(orderdate) = CURRENT_DATE) as today_online_revenue,
    ...
    'sales_trends' => $conn->query("
        SELECT 
            ...
            COUNT(DISTINCT CASE WHEN co.ordertype = 'Delivery' THEN ol.orderid END) as online_orders,
            ...
            <div class="orders-section">
                <div class="section-header">
                    ...
                    <div class="tab-navigation">
                        ...
                        <button class="tab-btn" onclick="showOrders('online')">Online/Delivery</button>
                    </div>
                </div>
