...
<body>
    ...
    <section class=" panel">
        ...
        <!-- === ADD CUSTOMER ORDER === -->
        <div>
            <div class="container-fluid" style="border-top:solid 5px #fa1;">
                        ...
                        <table id="customerOrderTable">
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < 1; $i++): ?>
                                    <tr>
                                        <td>
                                            <input type="text" name="productCode[]" placeholder="Product Code" onkeyup="runGetProductStock(this, event)">
                                        </td>
                                        <td>
            ...
            <script>
                ...
                function runGetProductStock(element, event) {
                    if (event.key === 'Enter') {
                        ...
                        xhttp.open("GET", "get_product_stock.php?productCode=" + productCode, true);
                        xhttp.send();
                    }
                }
            </script>
...
/******  4a24719b-e1b7-4042-8b67-01f915ce7688  *******/