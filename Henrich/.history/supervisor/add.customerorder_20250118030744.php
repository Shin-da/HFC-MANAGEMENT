...
/*************  ✨ Codeium Command 🌟  *************/
                                            <select id="productcode<?= $i ?>" name="productcode[]">
                                                ...
                                                foreach ($productcodes as $productcode) {
                                                    $productname = ''; // retrieve product name based on product code
                                                    $productweight = ''; // retrieve product weight based on product code
                                                ?>
                                                    <option value="<?= $productcode ?>">
                                                        <?= $productcode ?> + <?= $productname ?> + <?= $productweight ?>
                                                    <option value="<?= $productcode ?>"><?= $productcode ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
/******  8ae9155d-45c9-4a37-81da-2316bec3d698  *******/
                                        </td>
