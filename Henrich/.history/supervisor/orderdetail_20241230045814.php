            ...
            <div class="order-body">
                ...
                if (isset($_GET['oid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if ($status === 'Completed') {
                            echo "
                            <button type='button' class='btn btn-success' onclick=\"printDocument('receipt')\">Print Receipt</button>
                            ";
                        }
                        echo "
                            <button type='button' class='btn btn-info' onclick=\"printDocument('invoice')\">Print Invoice</button>
                            <script>
                                function printDocument(type) {
                                    var printContents = document.getElementById(type).innerHTML;
...
<div id='receipt' class='receipt-content'>
    <?php var_dump($customername, $customeraddress, $customerphonenumber, $orderdescription, $ordertotal, $orderdate, $salesperson); ?>
