...
<body>
   ...
   <input type='hidden' name='oid' value='$oid'>
                        ...
                        echo "</ul>
                            ...
                            <div id='invoice' class='receipt-content order-header'>
                                <div class='invoice-container '>
                                    <div class='invoice-header'>
                                        <div class='invoice-logo'>
                                            <img src='../resources/images/hfclogo.png' alt='Company Logo'>
                                        </div>
/*************  ✨ Codeium Command 🌟  *************/
                                        <div class='invoice-info'>
                                            ...
                                            <p>Issuer: " . htmlspecialchars($_SESSION['username'] ?? 'Unknown') . "</p>
                                        </div>
/******  9246e1ad-9b23-4cba-be73-a221f971b8cd  *******/
                                    </div>
                                    <hr>
