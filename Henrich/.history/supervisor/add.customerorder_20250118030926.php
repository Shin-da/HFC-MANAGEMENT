                        ...
                        <table id="customerOrderTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <select class="form-control"  id="productcode<?= $i ?>" name="productcode[]">
                                                <?php
                                                ...
                                                ?>
                                                    <option placeholder="Product Code" value="<?= $productcode ?>"><?= $productcode ?> - <?= $productName ?> (<?= $productWeight ?> Kg)</option>
                                                <?php
                                                    }
                                                }
                                                ?>
