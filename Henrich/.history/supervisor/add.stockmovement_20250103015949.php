    ...
    <section class=" panel">
        ...
        <div class="container-fluid">
            <div class="table-header">
                ...
                <h3>Batch Details</h3>
            </div>make a search bar for searching productcode or product name, results will show below. then  when selected create a new row and populate the fields 

            <div class="container-fluid" style="overflow-y: scroll; border-top: 8px solid var(--border-color);">
