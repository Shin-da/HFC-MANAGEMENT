    ...
    <section class=" panel">
        ...
        <div class="container-fluid"> <!-- Stock Management -->
            <div class="table-header">
                <div class="title">
                    <span>
                        <h2 style="color: var(--accent-color);">Orders </h2>
                    </span>
                    <span style="font-size: 12px; color: var(--accent-color);">Recent Customer Orders (Online and Walk-in)</span>
                </div>
                <div class="title">
                    <span style="color: var(--accent-color);"><?php echo date('l, F jS') ?></span>
                </div>
            </div>
...
<!-- organize the code arrangement, make functions for efficiency -->
                        <tbody id="table-body">
                            <?php
