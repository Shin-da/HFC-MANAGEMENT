...
<head>
    ...
    <style>
        ...
        <a href="javascript:window.history.back()"><i class='bx bx-chevron-left'></i> </a>
        .order-detail {
            max-width: 600px;
            margin: 20px auto;
            padding: 20px;
    ...
    <div class="panel">
        ...
        <div class="order-detail">
            <div class="order-header">
                <a href="javascript:window.history.back()" class="back-toprev"> <i class='bx bx-chevron-left'></i> </a>
                <h2>Order Detail</h2>
