  ...
  <section class=" panel"><!-- === Inventory === -->
    ...
    <div class="container-fluid"> <!-- Stock Management -->
      ...
      <div class="table-header">
        ...
        $start = ($page - 1) * $limit;
        $sort = isset($_GET['sort']) ? $_GET['sort'] : 'iid';
      ...
      <div class="">
        <div class="container-fluid" style="overflow-x:Scroll;">
          ...
          <table class="table" id="myTable">
            <thead>
              <tr>
                <th><a href="?sort=iid&order=<?= $sort === 'iid' && $order === 'ASC' ? 'DESC' : 'ASC' ?>">Inventory ID</a></th>
                ...
                <th><a href="?sort=onhand&order=<?= $sort === 'onhand' && $order === 'ASC' ? 'DESC' : 'ASC' ?>">On Hand (Pieces)</a></th>
...
/*************  ✨ Codeium Command 🌟  *************/
        <div class="container" style="display: flex; justify-content: center; flex-direction: column; align-items: center; background-color: var(--bg-color);"><!-- Pagination for stock management -->
...
/******  fe662b76-2cc8-4355-ad67-62643b9a5805  *******/
      </div>
