...
error_log("Session data in supervisor/index.php: " . print_r($_SESSION, true));
...
<body class="supervisor-body">
    ...
    include '../includes/supervisor_sidebar.php';  // Changed to supervisor-specific sidebar
    ?>
    ...
    <script src="../assets/js/supervisor-sidebar.js"></script>
