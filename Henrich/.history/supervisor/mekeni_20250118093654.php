...
$top_products_query = "SELECT 
    ...
    GROUP BY pl.productid, pl.productname, pl.availablequantity, pl.reorderpoint
...
$reorder_query = "SELECT 
    ...
    CASE 
        WHEN COUNT(co.orderid) > 0 THEN ROUND(pl.availablequantity / (COUNT(co.orderid) / 30))
        ELSE NULL 
...
/******  8b86852b-f923-4a4c-8e13-84e60637f8d9  *******/