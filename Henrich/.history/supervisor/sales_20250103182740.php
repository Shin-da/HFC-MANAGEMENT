...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="table-header">
          ...
          <div class="col-md-12">
            <div class="container" style="background-color: white; padding: 1rem; border-radius: 5px; border: 1px solid var(--border-color);">
            <div class="table-header">
          <form>
            <label for="year">Year:</label>
            <select id="year" name="year">
  ...
  <div class="pagination" style="display: flex; justify-content: space-around; align-items: center; width: 100%;">
...
/******  7940a0ec-072e-47e5-88ed-4f0903edfd55  *******/
