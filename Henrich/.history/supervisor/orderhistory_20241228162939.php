                    ...
                    <table class="table" id="myTable">
                        <thead>
                            ...
                            <tr class="filter-row">
                                ...
                                <th><input type="text" placeholder="Search price..." id="price-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 5)"></th>
                                <th><input type="text" placeholder="Search Date ..." id="dateupdated-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 6)"></th>
                            </tr>
                        </thead>
...
/******  0b01624a-265f-4adc-a0bb-54513433a6f0  *******/