...
<body>
    ...
    <!-- === Orders === -->
    <section class=" panel" style="background-color:var(--accent-color-dark);"> <!-- === Orders === -->
        <?php include '../reusable/navbarNoSearch.html'; // TOP NAVBAR         
        ?>

        <div class="container-fluid" style="background-color:var(--accent-color);"> <!-- Stock Management -->
            <div class="table-header" style="background-color:var(--accent-color);justify-content: center">
                <div class="title" style="color:var(--text-color-white)">
                    <span>
                        <h2>Mekeni </h2>
                    </span>
                ...
                <div class="tab-2">
                    ...
                    <div>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas consequat id velit quis vestibulum. Nam id orci eu urna mollis porttitor. Nunc nisi ante, gravida at velit eu, aliquet
                            sodales dui. Sed laoreet condimentum nisi a egestas.
                        <p>Donec interdum ante
