...
<body>
    <?php require '../reusable/sidebarnav.php'; ?>
        <div class="container-fluid">
            ...
            <div class="table-header">
                ...
                $items = $conn->query("SELECT * FROM orderlog $dateCondition ORDER BY timeoforder ASC LIMIT $start, $limit");
                $totalRecords = $conn->query("SELECT COUNT(DISTINCT orderid) FROM orderlog $dateCondition")->fetch_row()[0];
