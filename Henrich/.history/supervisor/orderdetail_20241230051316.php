/*************  ✨ Codeium Command 🌟  *************/
                        <button type='button' class='btn btn-info' onclick=\"printReceiptAndInvoice()\">Print Receipt and Invoice</button>
                        <script>
                            function printReceiptAndInvoice() {
                                var printContents = document.getElementById('receipt').innerHTML + "<br><br>" + document.getElementById('invoice').innerHTML;
...
/******  b1b8c52e-5f03-4f87-8410-660e77ad9d2d  *******/