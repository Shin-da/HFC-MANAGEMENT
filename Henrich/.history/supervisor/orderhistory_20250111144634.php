        ...
        <div class="container-fluid">
            ...
            <div class="">
                ...
                <div class="pagination">
                    <button class="btn btn-primary" onclick="location.href='orderhistory.php?page=<?= $page - 1 ?>'">Previous</button>
                    <button class="btn btn-primary" onclick="location.href='orderhistory.php?page=<?= $page + 1 ?>'">Next</button>
            </div>
        </div>
    </div>
