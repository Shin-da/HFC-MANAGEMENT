                ...
                if (isset($_GET['oid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class='order-item'>
                            ...
                            <span>" . htmlspecialchars($customeraddress) . "</span>
                            <span>$customeraddress</span>
                        </div>
                        <div class='order-item'>
                            <span>Customer Phone Number:</span>
                            <span>" . htmlspecialchars($customerphonenumber) . "</span>
                        ...
                        <div class='order-item'>
                            ...
                            <form action='' method='post'>
                                ...
                                </select>make the appearancec and format of the invocie and receipt more professional
...
/******  140b1399-6ce6-4eea-9265-9ef02e1fd05c  *******/