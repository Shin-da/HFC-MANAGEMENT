    ...
    <div class="panel">
        ...
        <div class="order-detail">
            <div class="order-header">
                <a href="javascript:window.history.back()"><i class='bx bx-chevron-left'></i> Back</a>
                <h2>Order Detail</h2>
                <p>Order ID: <?php echo isset($oid) ? $oid : 'N/A'; ?></p>
            </div>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class='order-item'>
                            ...
                            if ($status == 'Completed') {
                                ...
                                <button type='button' class='btn btn-success' onclick=\"window.print()\">Print Order</button>
                                ";
                            }
                            echo "
                        </div>
...
/******  32c19d75-1350-4b38-867d-9d1e62f88972  *******/