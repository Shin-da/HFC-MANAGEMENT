...
/*************  ✨ Codeium Command 🌟  *************/
                                        <td>
                                            <select id="productcode<?= $i ?>" name="productcode[]" onchange="showProductDetails(this)">
                                                <option value="">Select Product</option>
                                            <select id="productcode<?= $i ?>" name="productcode[]">
                                                <?php
                                                $productcodesql = "SELECT productcode, productname, weightperpiece FROM productlist";
                                                $result = $conn->query($productcodesql);
                                                while ($row = $result->fetch_assoc()) {
                                                foreach ($productcodes as $productcode) {
                                                ?>
                                                    <option value="<?= $row['productcode'] ?>"><?= $row['productcode'] . ' - ' . $row['productname'] . ' - ' . $row['weightperpiece'] . 'Kg' ?></option>
...
/******  52c19c90-0f44-4404-9227-aac81c62f93b  *******/
