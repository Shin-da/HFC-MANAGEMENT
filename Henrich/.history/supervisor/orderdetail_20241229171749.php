                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $oid = $_GET['oid'];
                                    $sql = "SELECT o.oid, c.customername, o.orderdate, p.productname, oi.orderquantity, p.price, o.orderdescription 
                                    $sql = "SELECT o.oid, c.customername, o.orderdate, p.productname, oi.quantity, p.price, o.orderdescription 
                                    FROM orders o 
                                    INNER JOIN customerdetails c ON o.customerid = c.customerid 
                                    INNER JOIN orders_items oi ON o.oid = oi.orderid 
...
/******  c87096dd-e854-492e-914e-27de46388901  *******/