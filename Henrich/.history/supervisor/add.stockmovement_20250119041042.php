            ...
            <div class="container-fluid" style="overflow-y: scroll; ">
                <form action="./process/add.stockmovement.process.php" method="POST">
                    ...
                    <table id="stockmovement">
                        ...
                        <tbody>
                            <?php
                            $productcodesql = "SELECT productcode FROM productlist";  // Changed from products to productlist
                            $result = $conn->query($productcodesql);
                            $productcodes = array();
                            while ($row = $result->fetch_assoc()) {
                                array_push($productcodes, str_pad($row['productcode'], 3, '0', STR_PAD_LEFT));
                            }
                            for ($i = 0; $i < 1; $i++):
                            ?>
                                <tr>
