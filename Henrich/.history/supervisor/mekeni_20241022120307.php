...
<body>
    ...
    <section class=" panel" style="background-color:var(--accent-color-dark);"> <!-- === Orders === -->
        ...
        <div class="container-fluid" style="background-color:var(---color);"> <!-- Stock Management -->
            <div class="table-header" style="background-color:var(---color);justify-content: center">
