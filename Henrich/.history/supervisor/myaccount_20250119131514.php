...
<body>
    ...
    // Display alerts if there are any messages in the session
    if (isset($_SESSION['success'])) {
        echo "<script>showSuccessToast('" . $_SESSION['success'] . "');</script>";
        unset($_SESSION['success']);
    }
    if (isset($_SESSION['error'])) {
        echo "<script>showErrorToast('" . $_SESSION['error'] . "');</script>";
    ...
    <script>
        ...
        document.querySelector('form[action*="edit-account.process.php"]').addEventListener('submit', function(e) {
            e.preventDefault();
            const form = this;
            showConfirmAlert(
                'Update Account',
        ...
        // Add confirmation for password change request
        document.querySelector('form[action*="request-password-change.process.php"]').addEventListener('submit', function(e) {
            e.preventDefault();
            const form = this;
            showConfirmAlert(
