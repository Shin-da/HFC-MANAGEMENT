            ...
            $(element).select2({
                ...
                $(`#productname${rowId}`).val(data.productname);
                        if (response.success) {
                            ...
                            $.ajax({
                                url: "./process/check_available_quantity.php",
                                data: { productcode: productCode },
                                dataType: 'json',
                                success: function(quantityResponse) {
                                    $(`#availablequantity${rowId}`).val(quantityResponse.availablequantity);
                                    $(`#stockstatus${rowId}`).val(quantityResponse.stockstatus);
                                }
                            });
                        }
                    }
