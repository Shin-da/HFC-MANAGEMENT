/*************  ✨ Codeium Command 🌟  *************/
                        <div id='receipt' class='receipt-content'>
                            ...
                            <div class='receipt-body'>
                                <p>Order ID: <?php echo htmlspecialchars($oid); ?></p>
                                <p>Customer Name: <?php echo htmlspecialchars($customername); ?></p>
                                <p>Customer Address: <?php echo htmlspecialchars($customeraddress); ?></p>
                                <p>Customer Phone: <?php echo htmlspecialchars($customerphonenumber); ?></p>
                                <p>Order Total: ₱ <?php echo htmlspecialchars($ordertotal); ?></p>
                                <p>Salesperson: <?php echo htmlspecialchars($salesperson); ?></p>
...
<p>Transaction Date: " . htmlspecialchars($orderdate) . "</p>
                        ...
                        echo "</ul>
                            ...
                            <div id='invoice' class='receipt-content'>
                              ...
                              <p>Order ID: " . htmlspecialchars($oid) . "</p>      
                                <p>Customer Name: " . htmlspecialchars($customername) . "</p>
                                <p>Customer Address: " . htmlspecialchars($customeraddress) . "</p>
                                <p>Customer Phone: " . htmlspecialchars($customerphonenumber) . "</p>
                                <p>Order Date: " . htmlspecialchars($orderdate) . "</p>
                                <p>Order Total: ₱ " . htmlspecialchars($ordertotal) . "</p>
                                <p>Salesperson: " . htmlspecialchars($salesperson) . "</p>
                                <p>Order Description:</p>
                                <ul style='list-style: none; padding: 0; margin: 0'>";
                        ...
                        if (isset($_SESSION['userlevel']) && $_SESSION['userlevel'] == 'admin') {
                            ...
                            <p>Invoice Date: <?php echo htmlspecialchars($orderdate); ?></p>
                            <p>Due Date: <?php echo htmlspecialchars(date('Y-m-d', strtotime($orderdate . ' + 30 days'))); ?></p>
                            <p>Bill To:</p>
                            <p><?php echo htmlspecialchars($customername); ?></p>
                            <p><?php echo htmlspecialchars($customeraddress); ?></p>
                            <p><?php echo htmlspecialchars($customerphonenumber); ?></p>
                            <p>Order Total: ₱ <?php echo htmlspecialchars($ordertotal); ?></p>
                            <p>Salesperson: <?php echo htmlspecialchars($salesperson); ?></p>
                            <p>Order Description:</p>
                            <ul style='list-style: none; padding: 0; margin: 0'>
...
/******  4bdc0ab2-3aa1-4506-9621-50c9a1336613  *******/