...
/*************  ✨ Codeium Command 🌟  *************/
                function addTableRow() {
                    ...
                    var columns = ['productcode', 'productname', 'productprice', 'productweight', 'quantity', 'quantityType', 'totalprice'];
                    ...
                    columns.forEach((key, i) => {
                        ...
                        switch (key) {
                            ...
                            case 'quantityType':
                                ...
                                newText.id = `quantityType${rowIndex}`;
                                newText.innerHTML = `<option value="" disabled selected>Quantity Type</option>
...
/******  154bf1ce-3200-4036-ac8b-178a0b53179b  *******/
