...
/*************  ✨ Codeium Command 🌟  *************/
            <div class="btn">
                <button class="btn btn-secondary" onclick="window.history.back();"><i class="bx bx-chevron-left bx-sm"></i> Back to Previous Page</button>
            </div>
                                <button class="btn btn-secondary" onclick="window.history.back();">Back to Previous Page</button>
                            </div>
/******  11d9bdf7-315a-48e2-aed8-011e45703d7d  *******/
