        ...
        <div class="container-fluid"> <!-- Stock Management -->
            <div class="table-header">
                <div class="title">
                    ...
                    <span style="font-size: 12px;">Recent Customer Orders</span>
                </div>
                <div class="title">
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            ...
                            <tr class="filter-row">
                                ...
                                <th><input type="text" placeholder="Search ordertotal..." id="price-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 5)"></th>
