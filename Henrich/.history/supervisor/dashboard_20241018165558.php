          ...
          <div class="right-panel">
               <div class="overview">
                    <div class="alertbox"><!-- Alerts -->
                         ...
                         <?php
                         $sql = "SELECT productcode, productname, onhand FROM inventory WHERE onhand <= 10 ORDER BY onhand ASC";
                         ...
                         <div class="alerts">
                              ...
                              ?>
                                        <div class="alertbox-content <?php echo $color; ?>">
                                             <div class="alert">
                                                  <p> <?php echo $row['productcode']; ?> - <?php echo $row['productname']; ?> has <?php $row['onhand']; ?> items left.</p>
                                             </div>
                                        </div>
                                   <?php
                                   }
                                   ...
                                   ?>
                                   <div class="alertbox-content " style="background-color: var(--light-teal);">
                                        <div class="alert">
