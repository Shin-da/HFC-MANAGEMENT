  ...
  <div class="out-of-stock-alert">
    <?php while ($row = $outOfStockItems->fetch_assoc()) { ?>
      <div class="alert-item out-of-stock-item">
        ...
        <span class="close" onclick="this.parentElement.classList.toggle('hidden')"><i class="bx bx-x"></i></span>
...
?>
/******  e3a7ee94-5d1e-41a5-8ec9-946242404f5d  *******/