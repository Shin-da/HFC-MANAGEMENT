...
/******  45b8b881-6916-444d-9796-a26646b303c8  *******/
</head>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="chartscontainer">
            ...
            <div id="polarAreaChartContainer" style="background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd; border-radius: 10px; width: 800px; overflow: visible; display: flex; flex-direction: column;">
              <canvas id="polarAreaChart"></canvas>
              <div id="productSalesList" style="margin-top: 20px; right: 0px;">
                <h4>Product Sales</h4>
                <ul>
