...
// Generate a unique order ID using date and random number
$orderid = date('Ymd') . sprintf("%04d", rand(0, 9999));
                ...
                <div class="order-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="orderid" value="<?php echo $oid; ?>" readonly required>
                        </div>
                        <div class="form-group">
