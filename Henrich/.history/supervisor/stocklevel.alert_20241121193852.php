...
<style>
  ...
  .alert .close {
    ...
    cursor: pointer;
    float: right;
    font-size: 1.5em; /* Enlarge the dismiss icon */
...
<?php
  ...
  if ($items->num_rows > 0) {
    ...
    echo '<span class="close" onclick="this.parentElement.style.display = \'none\'"><i class="bx bx-x"></i></span>'; // Moved before the heading
...
/******  bbd7527c-f35e-4613-9668-90b0be48d96f  *******/