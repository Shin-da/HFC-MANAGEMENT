...
<?php
  ...
  if ($outOfStockItems->num_rows > 0 && $show_stock_alert) { ?>
   <div class="out-of-stock-alert">
    <span class="alert-icon"><i class="bx bx-error"></i></span>
  ...
  <div class="out-of-stock-content">
    ...
    <span class="close" onclick="this.parentElement.parentElement.style.display = 'none'"><i class="bx bx-x"></i></span>
...
/******  16ee1e97-259d-4806-b137-d64562ca3ff4  *******/