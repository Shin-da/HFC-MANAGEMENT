...
// Get low stock count
$query = "SELECT COUNT(*) as count FROM products WHERE availablequantity <= reorder_level AND quantity > 0";
...
$query = "SELECT COUNT(*) as count, COALESCE(SUM(ordertotal), 0) as total FROM orders WHERE DATE(orderdate) = '$today'";
$result = $conn->query($query);
if ($result && $row = $result->fetch_assoc()) {
