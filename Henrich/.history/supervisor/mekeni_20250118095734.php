...
$low_stock_items = $conn->query("SELECT COUNT(*) as low_stock FROM inventory WHERE availablequantity <= reorder_point")->fetch_assoc()['low_stock'];
?>
<!DOCTYPE html>
<html>
<head>
                                    ...
                                    <tbody>
                                        ...
                                        $suggested_products = $conn->query("
                                            SELECT 
                                                ...
                                                GREATEST(0, (i.reorder_point - i.availablequantity)) as suggested_order
                                            FROM inventory i
