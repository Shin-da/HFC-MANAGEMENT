...
<body>
    ...
    <section class=" panel" style="background-color:var(--accent-color-dark);"> <!-- === Orders === -->
        ...
        <div class="container-fluid"  style="background-color: var(--panel-color) ;"> <!-- Stock Management -->
            <div class="table-header" style="backgroung-color:var(--accent-color-dark); justify-content: center">
