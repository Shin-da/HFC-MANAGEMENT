            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.results && response.results.length > 0) {
                        ...
                        $(`#productprice${rowId}`).val(product.productprice);
                        $(`#productweight${rowId}`).val(product.productweight);
                        $(`#availablequantity${rowId}`).val(product.onhandquantity);
                        $(`#stockstatus${rowId}`).val(getStockStatus(product.onhandquantity));
                        
                        // Trigger quantity calculation if there's a value
                        var quantityInput = $(`#quantity${rowId}`);
            ...
            return $(`
                <div class="select2-result-product">
                    <div class="product-info">
                        ...
                        <small>Price: ₱${product.productprice} | Weight: ${product.productweight}kg</small>
                    </div>
