/*************  ✨ Codeium Command 🌟  *************/
            <li class="<?php echo ($current_page == 'index') ? 'active' : ''; ?>"><a href="index.php"><i class="bx bx-home-alt icon"></i><span>Dashboard</span></a></li>
<?php
// session_start();
...
/******  7cc0c962-8829-43c5-a936-cc9c3746abee  *******/