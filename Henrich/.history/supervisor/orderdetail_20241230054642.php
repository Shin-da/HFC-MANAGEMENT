...
<style>
        ...
        .receipt-header, .invoice-header {
            ...
            background-color: #f0f0f0;
            padding: 10px;
        .receipt-content h2, .invoice-content h2 {
            font-size: 18px;
            font-weight: 600;
            margin-bottom: 10px;
        }

        .receipt-content p, .invoice-content p {
            margin-bottom: 10px;
        }

        .receipt-content ul, .invoice-content ul {
            list-style: none;
            padding: 0;
            margin: 0;
        }

        .receipt-content li, .invoice-content li {
            margin-bottom: 10px;
        }

        .receipt-content table, .invoice-content table {
            width: 100%;
            border-collapse: collapse;
        }

        .receipt-content table tr td, .invoice-content table tr td {
            padding: 5px;
            border-bottom: 1px solid #ccc;
        }
        ...
        .receipt-header h2, .invoice-header h2 {
            font-size: 24px;
        .receipt-content table tr:last-child td, .invoice-content table tr:last-child td {
            border-bottom: none;
        }

        .receipt-content table tr td:first-child, .invoice-content table tr td:first-child {
            font-weight: 600;
            margin: 0;
        }
        ...
        .receipt-body table tr:last-child td, .invoice-body table tr:last-child td {
            border-bottom: none;
        }
        ...
        .receipt-info, .invoice-info {
            margin-left: 20px;
        }

        .receipt-bill-to, .invoice-bill-to {
            margin-top: 20px;
        }

        .receipt-items, .invoice-items {
            margin-top: 20px;
        }

        .receipt-salesperson, .invoice-salesperson {
            margin-top: 20px;
        }
        ...
        .receipt-footer-text, .invoice-footer-text {
            font-size: 12px;
            margin: 0;
        }
    </style>
...
/******  3cb3fc65-3dbc-4dea-840c-6f4eca132caa  *******/