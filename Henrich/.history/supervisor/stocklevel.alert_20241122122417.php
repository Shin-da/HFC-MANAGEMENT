...
<?php
  ...
  if ($outOfStockItems->num_rows > 0 && $show_stock_alert) {
    ...
    echo '<i class="bx bx-error" style="font-size: 2em;"></i><span class="close" onclick="this.parentElement.parentElement.style.display = \'none\'"><i class="bx bx-x"></i></span>';
...
/******  cdc74211-a359-4f34-a2a0-095bddb549b2  *******/