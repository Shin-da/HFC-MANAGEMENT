    ...
    <section class=" panel">
        ...
        <div class="container-fluid"> <!-- Stock Management -->
            ...
            <div class="table-header">
                ...
                <div style=" display: flex; justify-content: space-around; align-items: center; width: 100%;"> <!-- <|start_header|>                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing <?= $start + 1 ?> to <?= $start + $limit ?> of <?= $totalRecords ?> entries</div>
...
/******  fcdffebc-3ef2-40df-96b6-82e27cb71794  *******/