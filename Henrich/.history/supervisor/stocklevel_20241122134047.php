...
<body>
  ...
  <?php include '../reusable/sidebar.php';  // Sidebar       <section class=" panel"><!-- === Inventory === -->
  ...
  <?php include 'stocklevel.alert.php'; // Stock Alerts        ?>
    ...
    <div class="container-fluid"> <!-- Stock Alerts -->
      <?php
      ...
      while ($row = $items->fetch_assoc()) {
        ...
        if ($quantity > 0) {
          ...
          echo '<div class="alert"><div class="alert-icon"><i class="bx bx-error-circle"> </i></div><div class="alert-content"><h4>Low Stock Alert!</h4><span class="product-name">' . $row['productname'] . '</span> - <span class="quantity">' . $quantity . '</span> units left ' . $legend . '<br /><span class="close" onclick="this.parentElement.style.display = \'none\'"><i class="bx bx-x"></i></span></div></div>';
        }
      }
      ?>
    </div>
    ...
    <div class="container-fluid"> <!-- Stock Management -->
      ...
      <?php // pagination for stock management table
        ...
        $stockManagementTableSQL = "SELECT * FROM inventory ORDER BY iid ASC LIMIT $limit OFFSET $offset";
          ...
          <table class="table" id="myTable">
            <thead>
              ...
              <tr class="filter-row">
                ...
                <th><input type="text" placeholder="Search On Hand..." id="onhand-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 4)"></th>
...
/******  db04aa9b-3db3-4cad-b6d5-8c01ebf85ae9  *******/