...
// Get total records count early
$total_records_query = "SELECT COUNT(*) as count FROM customerdetails";
$total_records = $conn->query($total_records_query)->fetch_assoc()['count'];

// Get today's active customers count
$today_active_query = "SELECT COUNT(DISTINCT customerid) as count FROM customerorder WHERE DATE(orderdate) = CURDATE()";
...
<body>
            ...
            <div class="dashboard-header">
                ...
                <div class="stats-container">
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-number">
                            <?php 
                                $today_active = $conn->query("SELECT COUNT(DISTINCT customerid) as count FROM customerorder WHERE DATE(orderdate) = CURDATE()")->fetch_assoc()['count'];
                                echo $today_active;
                            ?>
                        </p>
                    </div>
            ...
            <div class="table-container">
                ...
                <table class="table" id="customerTable">
                    ...
                    <?php
                        ...
                        $total_records = $conn->query("SELECT COUNT(*) as count FROM customerdetails")->fetch_assoc()['count'];
    ...
    <script>
                ...
                if (data.success) {
                    document.getElementById('customerDetails').innerHTML = `
                        <div class="customer-info">
                            ...
                            <p><strong>Address:</strong> ${data.customer.customeraddress}</p>
                            <p><strong>Phone:</strong> ${data.customer.customerphonenumber}</p>
        ...
        // ...existing functions with enhanced error handling...
    </script>
</body>
