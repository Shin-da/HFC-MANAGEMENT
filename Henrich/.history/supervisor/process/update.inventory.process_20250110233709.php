...
$stmt = $conn->prepare("INSERT INTO inventory (productcode, onhandquantity, productname, productcategory, dateupdated) VALUES (?, ?, ?, ?, NOW()) ON DUPLICATE KEY UPDATE onhandquantity = onhandquantity + VALUES(onhand)");
