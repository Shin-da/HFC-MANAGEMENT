...
$stmt = $conn->prepare("UPDATE inventory SET onhand = onhandq + ?, productname = ?, productcategory = ?, dateupdated = NOW() WHERE productcode = ?");
...
$stmt = $conn->prepare("INSERT INTO inventory (productcode, onhand, productname, productcategory, dateupdated) VALUES (?, ?, ?, ?, NOW()) ON DUPLICATE KEY UPDATE onhand = onhand + VALUES(onhand)");
