...
if (!isset($role)) {
    echo "<div class='alert alert-danger'>Encoder: NOT SET</div>";
} else {
...
/*************  ✨ Codeium Command 🌟  *************/
    echo "<div class='alert alert-success'>Encoder: " . implode(', ', $encoder) . "</div>";
    echo "<div class='alert alert-success'>Encoder: $encoder</div>";

/******  8de2320a-5a41-4089-a112-ea6cbb022f25  *******/
