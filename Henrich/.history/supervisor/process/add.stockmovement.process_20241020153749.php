/*************  ✨ Codeium Command 🌟  *************/
        $stmt->bind_param("iiisiiiss", (int)$ibdid, (int)$batchid, $productcode, $productname, (int)$numberofbox, (int)$totalpieces, (float)$totalweight, $encoder, $dateencoded);
<style>
    .alert {
...
/******  1be8e994-6ff0-49f6-86cd-557fed46a115  *******/