...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($productcodes as $key => $productcode) {
        ...
        $stmt = $conn->prepare("INSERT INTO stockmovement (ibdid, batchid, encoder, quantityp, weightperpiece, totalpieces, totalweight, dateencoded) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssss", $ibdid, $batchid, $encoder, $quantity, $weightperpiece, $totalpieces, $totalweight, $dateencoded);
