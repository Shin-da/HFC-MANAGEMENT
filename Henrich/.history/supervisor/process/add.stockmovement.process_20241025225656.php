...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    foreach ($productcodes as $key => $productcode) {
        ...
        $stmt->bind_param("issiiiss", $ibdid, $batchid, $productcode, $productname, $numberofbox, $totalpieces, $totalweight, $encoder, $dateencoded);
...
?>
/******  c6d0f6e1-9d84-4977-b2f0-2d670b797ba5  *******/
<?= '</div>'; ?>
