...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    }insert individual ordered products into orderedproduct table first, then show the received datas on a table. after that insert the rows in orderedproducts to orderhistory  in one row 
