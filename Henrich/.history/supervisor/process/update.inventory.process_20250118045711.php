...
$stmt = $conn->prepare("INSERT INTO inventory (productcode, availablequantity, productname, productcategory, dateupdated) VALUES (?, ?, ?, ?, NOW()) ON DUPLICATE KEY UPDATE onhandquantity = onhandquantity + VALUES(onhandquantity)");
