...
/*************  ✨ Codeium Command 🌟  *************/
    $orderdescription = '';
    foreach ($productname as $key => $value) { 
        $orderdescription .= htmlspecialchars($value . ", " . (isset($productweight[$key]) ? $productweight[$key] : 'N/A') . " kg, " . (isset($quantity[$key]) ? $quantity[$key] :
...
/******  43853e8f-bda7-44e2-a93b-c15327589cbc  *******/
