...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    $encoders = array_fill(0, count($productcodes), (string)$encoder);
    $encoders = array_fill(0, count($productcodes), $encoder);

    $dateencoded = $_POST['dateencoded'] ?? '';
    $dateencodeds = array_fill(0, count($productcodes), (string)$dateencoded);
    $dateencodeds = array_fill(0, count($productcodes), $dateencoded);
/******  8b74df72-a697-4e25-a630-df9426243ce5  *******/
