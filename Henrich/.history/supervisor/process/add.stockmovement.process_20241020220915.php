...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    foreach ($productcodes as $key => $productcode) {
        ...
        $stmt = $conn->prepare("INSERT INTO stockmovement (ibdid, batchid, productcode, productname, numberofbox, totalpieces, totalweight, encoder, dateencoded, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $stmt->bind_param("iiisiiissis", $ibdid, $batchid, $productcode, $productname, $numberofbox, $totalpieces, $totalweight, $encoder, $dateencoded, $role);
...
?>
<?= '</div>'; ?>
/******  be563b97-c01d-4fa0-a9b1-eafd65b4c992  *******/
