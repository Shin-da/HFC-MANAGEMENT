...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    if ($stmt = $conn->prepare($sql)) {
        foreach ($productname as $key => $value) {
            ...
            $stmt->bind_param("isdisi", $orderIDValue, $productCodeValue, $value, $productWeightValue, $productPriceValue, $quantityValue, $orderDateValue);
...
/******  11bc31f5-914a-4e11-b070-238b8af35360  *******/
        $stmt->close();
    } else {
