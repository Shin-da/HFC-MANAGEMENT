...
$dashboard_data = [
    ...
    'sales_trends' => $conn->query("
        SELECT 
            ...
            SUM(CASE WHEN co.ordertype = 'Online' THEN ol.quantity * ol.unit_price ELSE 0 END) as online_sales,
            SUM(CASE WHEN co.ordertype = 'Delivery' THEN ol.quantity * ol.unit_price ELSE 0 END) as delivery_sales,
            SUM(CASE WHEN co.ordertype = 'Walk-in' THEN ol.quantity * ol.unit_price ELSE 0 END) as walkin_sales
        FROM orderlog ol
