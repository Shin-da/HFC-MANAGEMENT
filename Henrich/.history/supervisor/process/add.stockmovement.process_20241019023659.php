...
<table>
    ...
    <tr>
        <td>ibdids</td>
        <td><?php echo "Array ( " . implode(", ", $ibdids) . " )"; ?></td>
    </tr>
    <tr>
        <td>batchids</td>
    ...
    <tr>
        <td>productcodes</td>
        <td><?php echo "Array ( " . implode(", ", $productcodes) . " )"; ?></td>
    </tr>
    <tr>
        <td>productnames</td>
        <td><?php echo "Array ( " . implode(", ", $productnames) . " )"; ?></td>
    </tr>
    <tr>
        <td>productcategories</td>
        <td><?php echo "Array ( " . implode(", ", $productcategories) . " )"; ?></td>
    </tr>
    <tr>
        <td>numberofboxes</td>
        <td><?php echo "Array ( " . implode(", ", $numberofboxes) . " )"; ?></td>
    </tr>
    <tr>
        <td>totalpiecess</td>
        <td><?php echo "Array ( " . implode(", ", $totalpiecess) . " )"; ?></td>
    </tr>
    <tr>
        <td>totalweightss</td>
        <td><?php echo "Array ( " . implode(", ", $totalweightss) . " )"; ?></td>
    </tr>
</table>
...
/******  f2bfcfea-8d08-4f05-a6cd-bcdeb06796cd  *******/