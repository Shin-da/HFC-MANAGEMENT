...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    if (!empty($productname)) {
        foreach ($productname as $key => $value) { 
            ...
            $orderdescription .= "Product: $value, Quantity: $quantityValue $quantityTypeValue, Price: $productPriceValue, Total: $orderTotalValue\n";
        }
    }
/******  1ff42232-0bf4-4504-8d5a-d4928f66e65d  *******/
