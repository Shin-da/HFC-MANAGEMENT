...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($productcodes as $key => $productcode) {
        ...
        $stmt = $conn->prepare("INSERT INTO stockmovement (batchid, productcode, productname, numberofbox, totalpieces, totalweight, encoder, dateencoded) VALUES (?,?,?,?,?,?,?,?)");
        $stmt->bind_param("isiiiss", $batchid, $productcode, $productname, $numberofbox, $totalpieces, $totalweight, $encoder, $dateencoded);
...
/******  f83ee983-7f8b-482f-b694-34994c6f01fc  *******/