...
<?php
  ...
  $showAlert = isset($_COOKIE['showAlert']) ? $_COOKIE['showAlert'] : 'true';

  if ($showAlert === 'true' && $outOfStockItems->num_rows > 0) {
    echo '<div class="out-of-stock-alert">';
    echo '<span class="close" onclick="dismissAlert(this)"><i class="bx bx-x"></i></span>';
  ...
  if ($showAlert === 'true' && $items->num_rows > 0) {
...
<script>
  function dismissAlert(element) {
    ...
    document.cookie = "showAlert=false; path=/";
    setTimeout(() => {
      document.cookie = "showAlert=true; path=/";
      location.reload();
    }, 3000);
  }
</script>
...
/******  7966a1e8-ff0a-4534-85cb-9461e9553d13  *******/