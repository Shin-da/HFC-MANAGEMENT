                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <input type="number" name="availablequantity[]" id="availablequantity<?= $i ?>" class="availablequantity" placeholder="Available Quantity" readonly>

                                        </td>
                                        <td><input type="text" name="stockstatus[]" id="stockstatus<?= $i ?>" class="stockstatus" placeholder="Stock Status" readonly></td>
                        ...
                        xhttp.onreadystatechange = function() {
                            if (this.readyState === 4 && this.status === 200) {
                                try {
                                    ...
                                    // Update the correct input fields using the index
                                    document.getElementById("availablequantity0").value = response.availablequantity;
                                    document.getElementById("stockstatus0").value = response.stockstatus;
