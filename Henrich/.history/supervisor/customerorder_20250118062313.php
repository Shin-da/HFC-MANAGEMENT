...
<body>
                                ...
                                <tr class="row-<?= $statusClass ?>" onclick="location.href='customerorderdetail.php?hid=<?= $row['hid'] ?>'">
                                    ...
                                    <td>
                                        <div class="status-cell status-<?= $statusClass ?>">
                                            ...
                                            $icon = '';
                                            switch ($row['status']) {
                                                case 'Pending': $icon = 'bx-time'; break;
                                                case 'Processing': $icon = 'bx-hourglass'; break;
                                                case 'Completed': $icon = 'bx-check'; break;
                                                case 'Cancelled': $icon = 'bx-x'; break;
                                            }
                                            ?>
    ...
    function filterByStatus(status) {
        ...
        rows.forEach(row => {
            ...
            const orderStatus = row.querySelector('td:nth-child(5) .status-cell')?.textContent.trim();
        ...
        document.querySelectorAll('.status-pill').forEach(button => {
            button.classList.toggle('active', button.textContent.trim() === status);
        });
