...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row['COUNT(*)'] > 0) {
            error_log("customer.php: Found " . $row['COUNT(*)'] . " new customers to update");
            // Update the customer table
            $sql2 = "INSERT INTO customerdetails (customername, customeraddress, customerphonenumber, customerid) SELECT o.customername, o.customeraddress, o.customerphonenumber, o.customerid FROM customerorder o LEFT JOIN customerdetails c ON o.customerid = c.customerid WHERE c.customerid IS NULL";
