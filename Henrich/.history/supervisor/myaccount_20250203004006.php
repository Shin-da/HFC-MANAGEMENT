...
function getStringValue(?string $value): string {
    return $value ?? '';
}

// Get user data with null safety
$userData = getUserData($pdo, $_SESSION['user_id'] ?? 0) ?: [
    'first_name' => '',
    'last_name' => '',
    'full_name' => '',
        ...
        <div class="user-profile-header">
            <div class="user-avatar-section">
                <div class="user-avatar">
                    <?php 
                    $first = substr(getStringValue($userData['first_name']), 0, 1);
                    $last = substr(getStringValue($userData['last_name']), 0, 1);
            ...
            <div class="user-info-section">
                <h1><?= htmlspecialchars(getStringValue($userData['full_name'])) ?></h1>
                <div class="user-meta">
                ...
                <form action="./process/edit-account.process.php" method="post" class="account-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="first_name" name="first_name" 
                                   value="<?= htmlspecialchars(getStringValue($userData['first_name'])) ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="last_name">Last Name</label>
                            <input type="text" id="last_name" name="last_name" 
                                   value="<?= htmlspecialchars(getStringValue($userData['last_name'])) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" 
                               value="<?= htmlspecialchars(getStringValue($userData['useremail'])) ?>" required>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username" 
                                   value="<?= htmlspecialchars(getStringValue($userData['username'])) ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="department">Department</label>
                            <input type="text" id="department" name="department" 
                                   value="<?= htmlspecialchars(getStringValue($userData['department'])) ?>" required>
                        </div>
                    </div>
