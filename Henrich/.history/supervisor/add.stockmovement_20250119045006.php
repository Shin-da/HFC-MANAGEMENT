        ...
        <script>
            ...
            $(document).ready(function() {
                $('form').on('submit', function(e) {
                    ...
                    // Validate form
                    if (!validateForm()) {
                        Alerts.inventory.error('Please fill in all required fields');
                        return;
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                Alerts.inventory.success(response.message);
                                setTimeout(() => {
                        ...
                        error: function() {
                            Alerts.inventory.error('An error occurred while processing your request');
                        }
                    });
                });
