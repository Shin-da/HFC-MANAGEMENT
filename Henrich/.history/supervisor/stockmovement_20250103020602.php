...
<body>
    ...
    <section class=" panel"><!-- === STOCK MOVEMENT === -->
        ...
        <div class="container-fluid"> <!-- === STOCK MOVEMENT === -->
            <div class="table-header" style="display: flex; flex-direction: column; align-items: center; width: 100%;">
                <div style=" display: flex; flex-direction: row ; gap: 10px; align-items: center; width: 100%;">
                    <div class="title">
