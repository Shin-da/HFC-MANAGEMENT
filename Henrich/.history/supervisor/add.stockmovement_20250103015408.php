    ...
    <section class=" panel">
            ...
            <div class="container-fluid" style="overflow-y: scroll">
                <form action="./process/add.stockmovement.process.php" method="POST"
                    <div class="search-container">
                        <input type="search" id="search" name="search" placeholder="Search productcode or productname" onkeyup="searchFunction()">
                    </div>
                <form action="./process/add.stockmovement.process.php" method="POST">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <select name="productcode[]" id="productcode<?= $i ?>" row-id="<?= $i ?>" onchange="fetchProductInfo(this)" required>
        ...
        <script>
            function searchFunction() {
                ...
                table = document.getElementById("stockmovement");
...
/******  f6a8a248-e79c-45bc-9fb0-5d446866f6bd  *******/