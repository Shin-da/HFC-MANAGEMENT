        ...
        <div class="order-detail-wrapper">
            ...
            <div class="order-items">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        // Parse the order description
                        $items = explode(',', $order['orderdescription']);
                        foreach ($items as $item): 
                            // Extract quantity and item name using regex
                                pl.productname,
                                pl.productweight,
                                pl.productprice as unit_price,
                                oi.quantity,
                                (oi.quantity * pl.productprice) as total_price 
                            FROM orderitems oi
                            JOIN productlist pl ON oi.productcode = pl.productcode
                        ...
                        ?>
                        <tr>
                            <td><?= htmlspecialchars($item['productname']) ?> (<?= $item['productweight'] ?>kg)</td>
                            <td><?= $item['quantity'] ?></td>
