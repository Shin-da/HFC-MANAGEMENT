...
<head>
    ...
    <script>
        var auto_refresh = setInterval(function () {
            $('#table-header').load(' #table-header');
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            ...
                            <tr class="filter-row">
                                ...
                                <th><input type="text" placeholder="Search salesperson..." id="salesperson-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this
...
/******  c3223023-af65-4c91-9760-a01a4a08ec21  *******/