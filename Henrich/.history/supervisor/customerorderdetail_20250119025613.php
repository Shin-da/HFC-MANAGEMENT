                ...
                if (result.isConfirmed) {
                    ...
                    .then(text => {
                        ...
                        try {
                            ...
                            // If update was successful but response is malformed,
                    ...
                    .catch(error => {
                        ...
                        // Show error but still reload since the update might have worked
                        Swal.fire({
                            icon: 'warning',
                            title: 'Status Might Have Updated',
                            text: 'Reloading page to check current status...',
                            timer: 2000,
                            showConfirmButton: false
                        }).then(() => {
                            location.reload();
