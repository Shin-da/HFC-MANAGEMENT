...
<?php
  ...
  if ($outOfStockItems->num_rows > 0) {
    ...
    echo '<span class="close" onclick="dismissAlert(this)" data-timer="5000"><i class="bx bx-x"></i></span>';
...
<script>
  function dismissAlert(element) {
    let timer = element.getAttribute('data-timer');
    setTimeout(function() {
...
/******  80b35ecb-549f-48e1-b8e0-04383420ec96  *******/