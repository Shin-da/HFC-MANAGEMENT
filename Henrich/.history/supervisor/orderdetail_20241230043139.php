            ...
            <div class="order-body">
                ...
                if (isset($_GET['oid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class='order-item'>
                            <span>Status:</span>
                            <span class='<?php echo htmlspecialchars($status) ?>'><?php echo htmlspecialchars($status) ?></span>
                            ...
                            <div id='receipt' class='receipt-content'>
                                ...
                                <p>Order Total: &cent; <?php echo htmlspecialchars($ordertotal) ?></p>
...
/******  7cb7bd38-a697-44bc-b656-5098f3e2b816  *******/