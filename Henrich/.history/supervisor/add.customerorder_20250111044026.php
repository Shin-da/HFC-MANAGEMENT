                    ...
                    <form action="./process/add.customerorder.process.php" method="POST">
                        ...
                        <div class="bottom-form">
                            <div class="order-summary">
                                <div>
                                    <span>Total Order Weight:</span>
                                    <input type="text" name="totalOrderWeight" id="totalOrderWeight" value="0.00" readonly>
                                </div>
                                <div>
                                    <span>Total Order Amount:</span>
                                    <input type="text" name="ordertotal" id="totalOrderAmount" value="0.00" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="bottom-form">
...
/******  0135d37b-491c-4f46-ad91-e2a1e1661d30  *******/
