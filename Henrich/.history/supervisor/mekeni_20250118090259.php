...
$reorder_query = "SELECT 
    ...
    ROUND(COUNT(co.orderid) / 30, 2) as avg_daily_sales,
    CASE 
        WHEN COUNT(co.orderid) > 0 THEN ROUND(pl.quantity / (COUNT(co.orderid) / 30))
        ELSE NULL 
    ...
    WHERE pl.supplier = 'Mekeni'
    GROUP BY pl.productname, pl.quantity, pl.reorderpoint
    HAVING pl.quantity <= pl.reorderpoint
