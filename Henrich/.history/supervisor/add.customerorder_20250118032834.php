...
var newProductCodeSelect = document.getElementById(`productcode${rowIndex}`);
                ...
                function getProductInfo(select) {
                    ...
                    // First AJAX call for product info
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status === 200) {
                            try {
                                ...
                                // Second AJAX call for available quantity
                                var quantityXhttp = new XMLHttpRequest();
                                quantityXhttp.onreadystatechange = function() {
                                    if (this.readyState == 4 && this.status === 200) {
                                        try {
                                            var quantityResponse = JSON.parse(this.responseText);
                                            if (availableQuantityElement && stockStatusElement) {
                                                availableQuantityElement.value = quantityResponse.availablequantity;
                                ...
                                console.error("Error parsing product info response:", e);
                            }
                        }
                    };
