    ...
    <section class=" panel">
        ...
        <div class="container-fluid"> <!-- Stock Management -->
            <div class="table-header" style="border-left: 8px solid #fa1;">
                ...
                <div class="icons">
                    <a href="javascript:location.reload()" class="icon-link"><i class="bx bx-refresh"></i> Refresh</a>
                    <a href="#" class="icon-link"><i class="bx bx-download"></i> Download</a>
...
/******  fdf9955d-9ffe-498d-924b-3599e1074561  *******/