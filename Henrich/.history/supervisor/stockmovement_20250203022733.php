...
<div class="stock-management-wrapper theme-aware">
    <div class="dashboard-header">
        <div class="welcome-section">
            <div class="title-section">
                ...
                <p class="subtitle">Track inventory movements</p>
            </div>
    ...
    <!-- <div class="stats-grid">
        <div class="stat-card">
                    ...
                    <div class="value"><?= number_format((float)$stats['total_movements'] ?? 0) ?></div>
                </div>
                <div class="stat-card success">
                    <div class="stat-icon"><i class='bx bx-log-in-circle'></i></div>
                    <h3>Stock In</h3>
                    <div class="value"><?= number_format((float)$stats['stock_in'] ?? 0) ?></div>
                </div>
                <div class="stat-card warning">
                    <div class="stat-icon"><i class='bx bx-log-out-circle'></i></div>
                    <h3>Stock Out</h3>
                    <div class="value"><?= number_format((float)$stats['stock_out'] ?? 0) ?></div>
                </div>
                <div class="stat-card info">
                    <div class="stat-icon"><i class='bx bx-package'></i></div>
                    <h3>Total Moved</h3>
                    <div class="value"><?= number_format((float)$stats['total_packs'] ?? 0) ?> packs</div>
                    <div class="sub-value">
                        <?= number_format((float)$stats['total_boxes'] ?? 0) ?> boxes /
                        <?= number_format((float)$stats['total_weight'] ?? 0, 2) ?> kg
                    </div>
                </div>
    </div> -->
