...
/*************  ✨ Codeium Command 🌟  *************/
  ...
  if ($items->num_rows > 0 && $show_stock_alert) {
    ...
    echo '<i class="bx bx-error-circle" style="color:#ffffff"></i><span class="close" onclick="this.parentElement.parentElement.style.display = \'none\'"><i class="bx bx-x"></i></span>';
    echo '<i class="bx bx-error"></i><span class="close" onclick="this.parentElement.parentElement.style.display = \'none\'"><i class="bx bx-x"></i></span>';
...
/******  77d67d3a-167a-4371-b2a5-9835102bb7a8  *******/
