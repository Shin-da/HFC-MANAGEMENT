...
if (isset($_POST['mark_read'])) {
    ...
    mysqli_query($conn, "UPDATE notifications SET is_read = 1 WHERE id = $notif_id AND user_id = {$_SESSION['uid']}");
...
/******  13ae14c4-e91e-49d8-ab85-b370da131783  *******/