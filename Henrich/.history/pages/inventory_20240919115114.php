  ...
  <section class=" panel">
    ...
    <div class="card">
      <div class="table-header">
        ...
        <a href="printInventory.php" class="buttonn"><i class='bx bx-printer'></i></a>
        <a href="exportInventory.php" class="buttonn"><i class='bx bx-import'></i></a>
        <a href="importInventory.php" class="buttonn"><i class='bx bx-export'></i></a>
        <a href="deleteInventory.php" class="buttonn"><i class='bx bx-trash'></i></a>
        <a href="editInventory.php" class="buttonn"><i class='bx bx-edit'></i></a>
        <a href="viewInventory.php" class="buttonn"><i class='bx bx-show'></i></a>
        <a href="searchInventory.php" class="buttonn"><i class='bx bx-search-alt-2'></i></a>
