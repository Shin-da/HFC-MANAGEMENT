...
/*************  ✨ Codeium Command 🌟  *************/
                    <td><input type="date" name="date[]" value="<?php echo date('Y-m-d'); ?>" placeholder="Date" style="width: 100%"></td>
    <style>
        table {
            ...
            border-radius: 5px;
                    ...
                    <script>
                        // make the format of the date yyyy-mm-dd, and make it automatic
...
/******  dcf74065-3554-41b0-a882-9f7de7fbfc0e  *******/
