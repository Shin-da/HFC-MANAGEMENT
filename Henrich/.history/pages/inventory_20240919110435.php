...
<head>
  ...
  <?php require '../reusable/header.php'; ?></head>
      ...
      <div class="table-container">
        ...
        <div class="container">
          ...
          <div class="pagination">
            <a href="?page=<?= $page - 1 <= 0 ? 1 : $page - 1 ?>" class="prev">&laquo;</a>
            <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
              <a href="?page=<?= $i ?>" class="page <?= $page == $i ? 'active' : '' ?>"><?= $i ?></a>
            <?php } ?>
            <a href="?page=<?= $page + 1 > $totalPages ? $totalPages : $page + 1 ?>" class="next">&raquo;</a>
          </div>
              <div class="">
...
<<<<<<<  745772fc-9610-46f6-9e9e-7187ec7b1dbb  >>>>>>>