...
?>
     ...
     <head>
          ...
          <script src="../rejs/datetime.js"></script> <!-- datetime -->
          <script src="../rjs/weather.js"></script> <!-- For weather -->
          <script src="../rjs/product_rank.js"></script> <!-- For Product rankin -->
          <!-- For holidays -->
          <script src="../rjs/holidays.js"></script>
