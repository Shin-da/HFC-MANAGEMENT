...
?>
     ...
     <head>
          ...
          <link rel="stylesheet" type="text/css" href="recss/dashboard.css">
          ...
          <script src="js/datetime.js"></script> <!-- datetime -->
          <script src="js/weather.js"></script> <!-- For weather -->
          <script src="js/product_rank.js"></script> <!-- For Product rankin -->
          <!-- For holidays -->
