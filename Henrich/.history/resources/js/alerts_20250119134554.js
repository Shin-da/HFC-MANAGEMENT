...
// Update ConfirmDialog to include backdrop styling
...
const AlertConfig = {
    baseConfig: {
        confirmButtonColor: '#598777',  // Sage green
        cancelButtonColor: '#933d24',   // Rust red
        denyButtonColor: '#de9a45'      // Warm orange
    },
    toastConfig: {
        toast: true,
        position: 'top-end',
