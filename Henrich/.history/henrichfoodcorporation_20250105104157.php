...
<head>
    ...
    <style>
        * {
        ...
        .products > .slider > .slider-inner > .slider-item {
        .products > .carousel > .carousel-inner > .carousel-item {
            width: 25%;
            margin: 0 10px;
        }

        .products > .slider > .slider-inner > .slider-item > img {
        ...
        .products > .slider > .slider-inner > .slider-item > h3 {
        .products > .carousel > .carousel-inner > .carousel-item > h3 {
            font-size: 1.2em;
            margin-top: 10px;
        }

        .products > .slider > .slider-inner > .slider-item > p {
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        sliders.forEach(slider => {
            const category = slider.closest(".products").querySelector("h2").textContent;
            const items = slider.querySelectorAll(".slider-item");
            const activeItem = slider.querySelector(".slider-item.active");
...
/******  f46a9f79-72d6-49ce-9411-222174399fdb  *******/