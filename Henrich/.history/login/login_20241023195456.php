...
if (isset($_POST['useremail']) && isset($_POST['password'])) {
	...
	$useremail = validate($_POST['useruseremail']);
	$uid = validate($_POST['uid']);
	$password = validate($_POST['password']);

	if (empty($useruseremail)) {
		header("Location: ../index.php?error=useruseremail is required");
		exit();
		...
		$sql = "SELECT * FROM user WHERE useruseruseremail='$useruseremail' AND password='$password'";
