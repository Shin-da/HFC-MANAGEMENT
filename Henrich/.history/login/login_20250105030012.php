...
/*************  ✨ Codeium Command 🌟  *************/
                if ($row['role'] === 'admin') {
                    ...
                    header("Location: ../admin/index.php?useremail=$useremail");
                } else if ($row['role'] === 'supervisor') {
                    header("Location: ../supervisor/index.php?useremail=$useremail");
                } else if ($row['role'] === 'ceo') {
                    header("Location: ../ceo/index.php?useremail=$useremail");
                }
                exit();
            } else {
