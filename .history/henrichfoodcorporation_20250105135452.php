...
<head>
    ...
    <link rel="stylesheet" href="./Henrich/resources/css/style.css">
    <style>
        * {
        ...
        .about-us:hover, .contact-us:hover {
            transform: translateY(-10px);
            box-shadow: 0 6px 12px rgba(0, 0, 0, 0.2);
        }
...
<body>
    ...
    <main>
        ...
        <section class="about" data-aos="fade-up">
            ...
            <p>Henrich Food Corporation is a family-owned and operated food truck company that serves delicious food to the people of Metro Manila. We specialize in providing fresh and healthy options for our customers, using only the best ingredients and high-quality products.</p>

            <p>Our mission is to bring the best food to the people of Metro Manila, and we are committed to providing our customers with the best service possible. We believe that food should be accessible to everyone, and we are dedicated to making sure that our customers have a great experience while enjoying our delicious food.</p>

            <p>Thank you for visiting our website, and we look forward to serving you soon!</p>
        </section>
                            ...
                            <div class="carousel-inner">
                                <?php foreach (array_slice($products, 0, 4) as $index => $product) : ?>
                                    <div class="carousel-item <?php echo $index === 0 ? 'active' : '' ?>">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <?php $imagePath = './Henrich/resources/images/' . $product['productimage']; ?>
                                                <img src="<?php echo file_exists($imagePath) ? $imagePath : '" ?>" alt="<?php echo $product['productname'] ?>" class="product-image" data-aos="zoom-in">
                                ...
                                <?php foreach (array_slice($products, 4) as $product) : ?>
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <?php $imagePath = './Henrich/resources/images/' . $product['productimage']; ?>
                                                <img src="<?php echo file_exists($imagePath) ? $imagePath : './Henrich/resources/images/placeholder.png'; ?>" alt="<?php echo $product['productname'] ?>" class="product-image" data-aos="zoom-in">
                                                <div class="product-info" data-aos="fade-up">
                                                    <h3 class="product-name"><?php echo $product['productname'] ?></h3>
                                                    <p><?php echo $product['productweight'] ?>g - <?php echo $product['productprice'] ?> PHP</p>
                                                </div>
