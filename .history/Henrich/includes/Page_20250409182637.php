...
class Page {
    ...
    public static function render(string $content): void {
        ...
        // Capture all output to avoid "headers already sent" errors
        ob_start();
        ...
        if (self::isAdminPage()) {
            ...
            // Check session before including admin sidebar
            if (isset($_SESSION['role']) && in_array($_SESSION['role'], ['admin', 'supervisor', 'ceo'])) {
                if ($_SESSION['role'] === 'admin') {
                    require_once dirname(__DIR__) . '/admin/admin-sidebar.php';
                } elseif ($_SESSION['role'] === 'supervisor') {
                    require_once dirname(__DIR__) . '/supervisor/supervisor-sidebar.php';
                } elseif ($_SESSION['role'] === 'ceo') {
                    require_once dirname(__DIR__) . '/ceo/ceo-sidebar.php';
                }
            }
            ...
            // Include footer and scripts at the end
        ...
        // Output all the buffered content at once
        ob_end_flush();
    }
