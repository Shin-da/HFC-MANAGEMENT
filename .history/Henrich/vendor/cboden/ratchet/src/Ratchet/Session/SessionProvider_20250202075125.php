...
class SessionProvider implements HttpServerInterface {
    ...
    private function parseCookie($cookie, $host = null, $path = null, $decode = false) {
        ...
        $packs = array_filter(array_map('trim', explode(';', $cookie)));

        // The name of the cookie (first kvp) must include an equal sign.
        if (empty($packs) || !strpos($packs[0], '=')) {
            return false;
        }
        ...
        // Add the cookie packs into the parsed data array
        foreach ($packs as $part) {
            ...
            // If cookies have not yet been retrieved, or this value was not found in the packs array, treat it as a
