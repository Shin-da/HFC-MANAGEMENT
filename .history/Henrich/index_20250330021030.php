        ...
        * {
        ...
        .left {
            ...
            conic-gradient(at 25% 25%,
                ...
                var(--c1) 0 300deg,
                var(--c2) 0),
            linear-gradient(-150deg, var(--_l)) var(--sage-medium)
            /* third color here */
            ;
...
<body>
    ...
    <div class="session">
        <div class="left">
            <div class="logo">
                <img src="./resources/images/Image.png" alt="HFC Logo">
            </div>
        </div>
        <div class="login-form">
            ...
            <form action="./login/login.php" method="post" class="log-in">
                ...
                <div class="bottom-form">
                    ...
                    <a href="./login/accountrequest.php">Request Account</a>
                    </div>
                </div>
            </form>
        </div>
