class LayoutManager {
    ...
    setState(state) {
        ...
        // Update all components based on state
        switch (state) {
            case 'expanded':
                this.sidebar?.classList.add('expanded');
                this.navbar.style.left = '260px';
                this.navbar.classList.remove('collapsed', 'hidden');
                this.pageWrapper.style.marginLeft = '260px';
                this.pageWrapper.classList.add('expanded');
                break;
            ...
            case 'collapsed':
                ...
                this.pageWrapper.classList.add('collapsed');
                break;
            ...
            case 'hidden':
                ...
                this.pageWrapper.classList.add('hidden');
                break;
        }
