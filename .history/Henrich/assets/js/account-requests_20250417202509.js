    ...
    fetch('../admin/api/get-request.php?id=' + requestId)
        ...
        .then(data => {
            if (data.success) {
                ...
                if (modalBody) {
                    modalBody.innerHTML = `<div class="alert alert-danger">${data.error || 'An error occurred while fetching request details.'}</div>`;
                }
            }
        })
        .catch(error => {
    ...
    if (confirm('Are you sure you want to approve this account request?')) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert(data.error || 'Failed to approve account request.');
            }
        })
        .catch(error => {
    ...
    if (reason !== null) {
        ...
        .then(data => {
            if (data.success) {
                ...
                alert(data.error || 'Failed to reject account request.');
            }
        })
        .catch(error => {
