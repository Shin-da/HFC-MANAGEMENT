class ChatManager {
    ...
    async openChat(userId) {
        try {
            ...
            const messageInput = document.querySelector('#messageInput');
            const sendButton = document.querySelector('#sendMessage');
            const userInfo = document.querySelector('#chatHeader .user-info');

            // Validate required elements exist
            if (!chatMain || !welcomeMessage || !chatConversation || !messageInput || !sendButton || !userInfo) {
                console.error('Missing required DOM elements for chat');
