class LayoutManager {
    ...
    handleResize() {
        ...
        if (width <= LAYOUT_CONFIG.BREAKPOINTS.MOBILE) {
            ...
            this.setState(LAYOUT_CONFIG.STATES.HIDDEN, false);
        } else if (width <= LAYOUT_CONFIG.BREAKPOINTS.TABLET && 
                   currentState === LAYOUT_CONFIG.STATES.EXPANDED) {
            // Collapse on tablet if was expanded
            this.setState(LAYOUT_CONFIG.STATES.COLLAPSED, false);
        }
    }
}
