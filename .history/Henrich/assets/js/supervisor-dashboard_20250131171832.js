...
const CHART_COLORS = {
    primary: '#385a41',     // forest-medium
    secondary: '#df5c36',   // rust-light
    accent: '#D4B95E',      // gold-accent
    warning: '#e5ba90',     // beige-warm
    danger: '#933d24',      // rust-medium
    success: '#2F5233',     // forest-primary
    info: '#7EA172',        // sage-medium
    neutral: '#1B4D3E'      // forest-deep
};

const CATEGORY_COLORS = [
    '#385a41', // forest-medium
    '#df5c36', // rust-light
    '#7EA172', // sage-medium
    '#933d24', // rust-medium
    '#2F5233', // forest-primary
    '#598777', // sage-dark
    '#8FBC8F', // sage-light
    '#6a362b'  // rust-dark
];
