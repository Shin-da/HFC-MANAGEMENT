...
// Attempt to log in via Remember Me cookie BEFORE checking session
require_once __DIR__ . '/includes/config.php'; // Use DIR for robustness
require_once __DIR__ . '/includes/functions.php'; // Use DIR for robustness
error_log("[DEBUG] index.php: Includes completed."); // Add debug log

attemptRememberMeLogin(); // This will restore the session if a valid cookie exists

// Now check if the user is logged in (either by existing session or remember me)
if (isset($_SESSION['user_id']) && isset($_SESSION['role'])) { // Changed uid to user_id
    ...
    <script>
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            */
            ...
            .then(response => response.json())  // Change to expect JSON response
            .then(data => {
