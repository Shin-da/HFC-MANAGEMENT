...
/*************  ✨ Codeium Command 🌟  *************/
                            echo "<tr><td colspan='7' style='text-align: center; font-size: 16px; color: red;'>It's quiet here.  No orders have been made yet.</td></tr>";
                            echo "<tr><td colspan='7' style='text-align: center;'>It's quiet here.  No orders have been made yet.</td></tr>";
/******  90a2a8d5-c9f1-4543-9cb9-6b7813ba3ff1  *******/
                        }
                        $conn->close();
                        ?>
                    </tbody>
