                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($currentOrderId !== $orderid) {
                                        if ($currentOrderId !== null) {
                                            echo "<tr class='clickable-row' onclick=\"location.href='orderdetail.php?orderid=$currentOrderId'\">";
                                    ...
                                    $orderProducts[] = $row['productcode'];
                                    $orderProducts[] = $row['productname'];
                                    $orderProducts[] = $row['productweight'];
                                    $orderProducts[] = "₱ " . $row['productprice'];
                                    $orderProducts[] = $row['quantity'];
                                    $orderProducts[] = date('d-m-Y', strtotime($row['orderdate']));
                                    $orderProducts[] = date('g:i A', strtotime($row['timeoforder']));
...
/******  7459cb39-50b3-48fd-a328-bf25591eea7b  *******/