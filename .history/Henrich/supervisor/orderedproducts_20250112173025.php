                        ...
                        <tbody id="table-body">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    $timeoforder = date('g:i A', strtotime($row['timeoforder']));cluster the rows with same id to indicate that they are related 
                                    if ($prevOrderId !== $orderid) {
                                        echo "<tr class='order-row'><td colspan='9' style='padding: 0'><div class='order-id'>Order ID: $orderid</div></td></tr>";
                                        $prevOrderId = $orderid;
                                    }
                                    ?>
                            ?>
...
/******  013cb7ce-4000-4ddb-ab3d-93b2202358bd  *******/