...
<div class="dashboard-wrapper">
    ...
    <!-- Add this just before the charts section -->
    <div id="chart-debug" style="display: none;">
        <pre></pre>
    </div>
    ...
    <!-- <div class="dashboard-grid">
        ...
        <div class="chart-card">
            ...
            <div id="productDistribution" class="chart-container">
                <div class="chart-loading">Initializing chart...</div>
            </div>
        </div>
    </div> -->
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Content loaded, checking dependencies...');
    const dependencies = {
    ...
    document.querySelector('#debug-info pre').textContent = 
