                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div id="availableQuantity<?= $i ?>"></div>
                                            <div id="statusIcon<?= $i ?>"></div>
                                        <td> <input type="text" id="stock-status<?= $i ?>" style="font-weight: bold;" readonly></input>
                                        </td>
...
/******  18332a4e-dafc-49e2-981e-ed951c1367f6  *******/
            ...
            <script>
                ...
                xhr.open('GET', 'Henrich/supervisor/process/check_available_quantity.php?productcode=' + productCode, true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        response = response.replace('<!-- xampp local -->', '');

                        // Parse the JSON response
                        var data = JSON.parse(response);

                        // Update the available quantity and status icon
                        document.getElementById('availableQuantity').innerHTML = data.availablequantity;
