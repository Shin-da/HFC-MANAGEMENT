...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("- Relative path: api/sales-data.php");
});
...
async function fetchSalesData(period = 'month', startDate = null, endDate = null) {
    let url = '/HFC%20MANAGEMENT/Henrich/supervisor/api/sales-data.php?action=sales&period=' + period;
...
async function fetchAnalyticsData(period = 'month', startDate = null, endDate = null) {
    let url = '/HFC%20MANAGEMENT/Henrich/supervisor/api/sales-data.php?action=analytics&period=' + period;
...
async function fetchRecommendationsData() {
    const url = '/HFC%20MANAGEMENT/Henrich/supervisor/api/sales-data.php?action=recommendations';
...
async function fetchInventoryData() {
    const url = '/HFC%20MANAGEMENT/Henrich/supervisor/api/sales-data.php?action=inventory';
