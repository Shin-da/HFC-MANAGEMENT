...
/*************  ✨ Codeium Command 🌟  *************/
            <div class="order-header">
                ...
                if (isset($_GET['hid'])) {
                    $hid = $_GET['hid'];
                    $sql = "SELECT timeoforder, ordertype FROM orderhistory WHERE hid = '$hid'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<p>Viewing $ordertype Order ID # $hid Created at: " . date('g:i A', strtotime($timeoforder)) . "</p>";
                        echo "<p>Viewing Order ID # $hid Created at: " . date('g:i A', strtotime($timeoforder)) . "</p>";
                    } else {
                        echo "<p>Viewing $ordertype Order ID # $hid</p>";
                        echo "<p>Viewing Order ID # $hid</p>";
                    }
                }
                ?>
            </div>
/******  5adc5dbc-76c6-48d9-b7ef-e7efd8bffa8f  *******/
