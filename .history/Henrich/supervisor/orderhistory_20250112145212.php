                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <?php
                                            ...
                                            onclick = "filterTable(document.querySelector('#myTable tbody'), 'All', 9)" > All < /button> <
                                                button class = "btn Pending"
                                            onclick = "filterTable(document.querySelector('#myTable tbody'), 'Pending', 9)" > Pending < /button> <
                                                button class = "btn Completed"
                                            onclick = "filterTable(document.querySelector('#myTable tbody'), 'Completed', 9)" > Completed < /button> <
                                                button class = "btn Cancelled"
                                            onclick = "filterTable(document.querySelector('#myTable tbody'), 'Cancelled', 9)" > Cancelled < /button> <
                                                /div> <
                                                /div>
                                            ...
                                            id = "hid-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 0)" > < /th> <
                                                th > < input type = "text"
                                            placeholder = "Search Time Ordered..."
                                            id = "order-date-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 1)" > < /th> <
                                                th > < input type = "text"
                                            placeholder = "Search Date Completed..."
                                            id = "datecompleted-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 2)" > < /th> <
                                                !-- < th > < input type = "text"
                                            placeholder = "Search OID..."
                                            id = "oid-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 3)" > < /th> --> <
                                                th > < input type = "text"
                                            placeholder = "Search customername..."
                                            id = "customername-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 4)" > < /th> <
                                                th > < input type = "text"
                                            placeholder = "Search customeraddress..."
                                            id = "customeraddress-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 5)" > < /th> <
                                                !-- < th > < input type = "text"
                                            placeholder = "Search customerphonenumber..."
                                            id = "customerphonenumber-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 6)" > < /th> --> <
                                                th > < input type = "text"
                                            placeholder = "Search orderdescription..."
                                            id = "orderdescription-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 7)" > < /th> <
                                                th > < input type = "text"
                                            placeholder = "Search order total..."
                                            id = "order-total-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 8)" > < /th> <
                                                th > < input type = "text"
                                            placeholder = "Search Status..."
                                            id = "order-status-filter"
                                            onkeyup = "filterTable(document.querySelector('#myTable tbody'), this.value, 9)" > < /th> <
                                                /tr> <
                                                /thead>
                                        ...
                                        ?>
                                            ...
                                            <
                                            div class = "container"
                                        style = "display: flex; justify-content: center; flex-direction: column; align-items: center; " > < !--Pagination-- >
                                            <
                                            ul class = "pagination" >
                                            <
                                            li > < a href = "?page=<?= $page - 1 <= 1 ? 1 : $page - 1 ?>"
                                        ...
                                        <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                            ...
                                            <?php } ?> <
                                            li > < a href = "?page=<?= $page + 1 > $totalPages ? $totalPages : $page + 1 ?>"
