            ...
            document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
              ...
              xhttp.onreadystatechange = function() {
                if (this.readyState === 4 && this.status === 200) {
                  ...
                  document.getElementById("availablequantity<?= $i ?>").dispatchEvent(new Event('input'));
                  document.getElementById("stockstatus<?= $i ?>").dispatchEvent(new Event('input'));
                }
              };
              xhttp.open("GET", "./process/check_available_quantity.php?productcode=" + productCode, true);
              xhttp.send();
...
/******  1563d171-ba8d-42a2-8b49-f1b3f3a1a10d  *******/