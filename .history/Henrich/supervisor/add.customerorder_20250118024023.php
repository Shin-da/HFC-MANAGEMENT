                ...
                document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState === 4 && this.status === 200) {
                            ...
                            var availableQuantityInput = document.querySelector(`#availablequantity${i}`);
                            var stockStatusInput = document.querySelector(`#stockstatus${i}`);
...
/******  b8ec2c0c-6379-4dd1-8cf5-56cebf6e0dc7  *******/
