        ...
        <?php else: ?>
            <div class="notification-list">
                <?php foreach ($notifications as $notification): ?>
                    <div class="notification-item <?php echo isset($notification['is_read']) && $notification['is_read'] ? 'read' : 'unread'; ?>" data-id="<?php echo $notification['id'] ?? 'unknown'; ?>">
                        <?php
                        // Determine icon based on severity and type, with default
                        $severity = $notification['severity'] ?? 'info'; // Default to 'info' if severity is missing
                        $iconClass = 'info';
                        ...
                        <div class="notification-content">
                            ...
                            <div class="notification-message"><?php echo htmlspecialchars($notification['message'] ?? 'No message content.'); ?></div>
                            <div class="notification-info">
                                <span class="notification-time"><?php echo isset($notification['created_at']) ? date('F j, Y, g:i a', strtotime($notification['created_at'])) : 'Unknown date'; ?></span>
