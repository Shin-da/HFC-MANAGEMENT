            ...
            <div class="order-header">
                ...
                if (isset($_GET['hid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<p><i class='bx bx-time bx-fw'></i> Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\">$hid</span> Created at: " . date('g:i A', strtotime($timeoforder)) . "</p>";
                        echo "<p>Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\">$hid</span> Created at: " . date('g:i A', strtotime($timeoforder)) . "</p>";
                    } else {
                        echo "<p><i class='bx bx-time bx-fw'></i> Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\">$hid</span></p>";
                        echo "<p>Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\">$hid</span></p>";
                    }
                }
                ?>
            </div>
/******  3dcc5bc4-587c-4f41-90f3-3a62b81d607a  *******/
