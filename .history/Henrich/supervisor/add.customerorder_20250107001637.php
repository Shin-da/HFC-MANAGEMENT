                        ...
                        if (key === 'quantityType') {
                            ...
                            if (key === 'quantity') {
                                newText.onchange = function() {
                                    var productprice = newRow.cells[4].children[0].value;
                                    var quantity = newText.value;
                                    var quantityType = newRow.cells[3].children[0].value;
                                    var totalprice = quantityType === 'per_piece' ? quantity * productprice : quantity * productprice / 25;
                                    newRow.cells[5].children[0].value = totalprice;
                                }
                            }
                            newCell.appendChild(newText);
                        }
...
/******  b93640c8-ac03-4c57-b37e-e661309d4467  *******/
