            ...
            <script>
                ...
                xhttp.onreadystatechange = function() {
                  if (this.readyState === 4 && this.status === 200) {
                    ...
                    var stockStatusInputs = document.querySelectorAll('.stockstatus');
                
                    availableQuantityInputs.forEach(function(input) {
                      input.value = response.availablequantity;
                    });
                
                    stockStatusInputs.forEach(function(input) {
                      input.value = response.stockstatus;
                    });
                  }
                };
                    xhttp.open("GET", "./process/check_available_quantity.php?productcode=" + productCode, true);
