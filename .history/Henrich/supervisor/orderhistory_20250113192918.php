            ...
            <div class="">
                ...
                <div class="card-footer">
                    <?php if ($result->num_rows > 0) { ?>
                        <p style="text-align: center;">Showing <?= $start + 1 ?> to <?= min($start + $limit, $totalRecords) ?> of <?= $totalRecords ?> entries</p>
                    ...
                    <?php } else { ?>
                        <p style="text-align: center; font-size: 16px; color: red;">No records found. Please try changing your search criteria.</p>
                    <?php } ?>
                </div>
            </div>
        </div>
...
/******  6d0cbac7-d449-4dd9-af18-3bcb112d1212  *******/