...
<body>
    ...
    <section class="panel">
        ...
        <div class="container-fluid">
            ...
            <?php
            $stockManagementTableSQL = "SELECT * FROM orderhistory ORDER BY orderdate DESC, timeoforder DESC LIMIT $limit OFFSET $start";
            $limit = isset($_GET['limit']) ? (int)$_GET['limit'] : 10;
            $offset = ($page - 1) * $limit;
...
/******  3667d4e6-c9dc-49da-bc55-669b90fbfb10  *******/