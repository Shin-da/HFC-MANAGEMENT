...
/*************  ✨ Codeium Command 🌟  *************/
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="quantity[]" placeholder="Quantity" onchange="calculateTotal(this)">
                                        </td>
                                        <td>
            ...
            <script>
                function addTableRow() {
                    ...
                    ['productcode', 'productname', 'quantity', 'quantityType', 'productprice'].forEach((key, i) => {
                    ['productcode', 'productname', 'quantity', 'productprice'].forEach((key, i) => {
...
/******  5725f67f-e61e-4cce-b9b4-a583240d5c0b  *******/
</body>
