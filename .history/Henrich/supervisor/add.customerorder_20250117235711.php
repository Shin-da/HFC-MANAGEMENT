                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="availablequantity0" id="availablequantity0<?= $i ?>" placeholder="Available Quantity" readonly>
                                        </td>
                                        <td><input type="text" name="stock-status0" id="stock-status0<?= $i ?>" placeholder="Stock Status" readonly></td>
