...
/*************  ✨ Codeium Command 🌟  *************/
                        <div class="order-item" style="border-left: 5px solid <?php
                            switch ($status) {
                                case 'Pending':
                                    echo '#ffc107';
                                    break;
                ...
                if (isset($_GET['hid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class='order-item'>
                            ...
                            switch ($status) {
                                case 'Pending':
                                    echo 'bx bx-hourglass';
                                    break;
                                case 'Ongoing':
                                    echo 'bx bx-sync';
                                    break;
                                case 'Completed':
                                    echo 'bx bx-check-circle';
                                    break;
                                case 'Cancelled':
                                    echo 'bx bx-x-circle';
                                    break;
                            }
                            ?>"></i> <?php echo htmlspecialchars($status); ?></span>
...
/******  9831c447-dec8-4dde-a5b1-b128962fea12  *******/
