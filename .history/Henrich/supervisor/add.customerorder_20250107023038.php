              ...
              function addTableRow() {
                  ...
                  function fetchProductInfo(element) {
                      ...
                      xhttp.onreadystatechange = function() {
                          if (this.readyState === 4 && this.status === 200) {
                              var response = JSON.parse(this.responseText);
                              var productCodes = response.productCodes;
                          // Populate the product code input field with available product codes
                          element.innerHTML = '';
                  ...
                  xhttp.open("GET", "get_product_codes.php", true);
                  xhttp.send();
               
              
                  // Call the fetchProductInfo() function to populate the product code input field
                  fetchProductInfo(newRow.querySelector('select[name="productcode[]"]'));
               
                  fetchProductInfo(productCodeInput);
...
/******  842459b9-7719-4a4a-9fe1-b56e5ecaff74  *******/
    </section>
