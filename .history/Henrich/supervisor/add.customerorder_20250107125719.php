...
/*************  ✨ Codeium Command 🌟  *************/
           ...
           function addTableRow() {
               ...
               var columns = ['productcode', 'productname', 'productweight', 'quantity', 'quantityType', 'productprice', 'totalprice'];
               ...
               xmlhttp.onreadystatechange = function() {
                   if (this.readyState == 4 && this.status == 200) {
                       ...
                       if (productNameElement && productWeightElement && productPriceElement) {
                           ...
                           console.error("HTML elements with IDs 'productname" + rowId + "', 'productweight" + rowId + "' and 'productprice" + rowId + "' not found in the DOM");
                       }
                   }
               };
...
/******  b02735ca-8e44-45a1-8858-6b632a706722  *******/
</body>
