    ...
    <section class="panel">
        ...
        <div class="container-fluid">
            ...
            <div class="table-header">
                ...
                $start = ($page - 1) * $limit;
                $items = $conn->query("SELECT * FROM orderhistory ORDER BY orderdate  DESC LIMIT $start, $limit");
            ...
            <div class="">
                <div class="container filters">
                    <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                        ...
                        <div>
                            <button class="status-button" style="background-color: var(--orange-color);" onclick="filterByStatus('Pending')">Pending</button>
                            <button class="status-button" style="background-color: var(--blue-color);" onclick="filterByStatus('Completed')">Completed</button>
                            <button class="status-button" style="background-color: var(--accent-color);" onclick="filterByStatus('Cancelled')">Cancelled</button>
                            <button class="status-button" style="background-color: var(--green-color);" onclick="filterByStatus('Ongoing')">Ongoing</button>
                            <button class="status-button" onclick="filterByStatus('Pending')">Pending</button>
                            <button class="status-button" onclick="filterByStatus('Completed')">Completed</button>
                            <button class="status-button" onclick="filterByStatus('Cancelled')">Cancelled</button>
                            <button class="status-button" onclick="filterByStatus('Ongoing')">Ongoing</button>
                        </div>
                    </div>
                </div>
...
/******  f9ffc043-de71-434c-b87b-542b3ce75329  *******/