                    ...
                    <form action="./process/add.customerorder.process.php" method="POST">
                        <div style="margin:0px; margin-bottom:40px;">
                            <table>
                                ...
                                <tr>
                                    <td><input type="text" name="oid[]" value="<?php echo $orderId; ?>" readonly required></td>
                        ...
                        <table id="customerOrderTable">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        <td>
                                            <select name="productcode" id="productcode" class="select-search" onchange="fetchProductInfo(this)" required>
                                        ...
                                        <td><input type="text" name="productname" id="productname" placeholder="Product Name" readonly></td>
                                        ...
                                        <td><input type="text" name="productprice" id="productprice" placeholder="Product Price" readonly></td>
                                        <td><input type="text" name="totalprice" id="totalprice" placeholder="Total Price" readonly></td>
...
/******  d22d75c0-1540-4fee-a351-1b408c4281a1  *******/
           ...
           function addTableRow() {
               ...
               var columns = ['productcode', 'productname', 'quantity', 'quantityType', 'productprice', 'totalprice'];
