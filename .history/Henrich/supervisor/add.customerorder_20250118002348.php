                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="availablequantity[]" id="quantity<?= $i ?>" placeholder="Available Quantity" readonly>
                                        </td>
                    ...
                    productCodeSelect.addEventListener("change", function() {
                        ...
                        xhttp.onreadystatechange = function() {
                            ...
                            if (this.readyState === 4 && this.status === 200) {
                                ...
                                alert("Error occurred while checking available quantity");
                            }
                        };
                        xhttp.open("GET", "./process/check_available_quantity.php?productcode=" + productCode, true);
                        xhttp.send();
...
/******  7668f402-f288-41b5-a09a-747915ae2405  *******/
            <script>
