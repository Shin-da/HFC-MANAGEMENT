                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                       ...
                                       <td>
                                           <input type="text" name="availablequantity[]" id="availablequantity0" placeholder="Available Quantity" readonly>
                                       </td>
                   ...
                   xhttp.onreadystatechange = function() {
                       if (this.readyState === 4 && this.status === 200) {
                           ...
                           if (response.error) {
                               ...
                               availableQuantityInput.value = availableQuantity;
           
                               // Show check or exclamation icon based on available quantity
