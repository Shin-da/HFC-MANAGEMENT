        ...
        <div>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    var productCodeSelect = document.getElementById("productcode0")    var response = JSON.parse(this.responseText);;
                    ...
                    productCodeSelect.addEventListener("change", function() {
                        ...
                        xhttp.onreadystatechange = function() {
                            ...
                            if (this.readyState === 4 && this.status === 200) {
                                try {
                                    var response = JSON.parse(this.responseText);
                                    var availableQuantity = document.getElementById("quantity0");
                                    availableQuantity.value = response.availablequantity;
                                    if (response.error) {
                                        alert(response.error);
                                    } else {
                                        var availableQuantity = response.availablequantity;
                                        var quantityInput = document.getElementById("quantity0");
            ...
            <script>
                ...
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        var stockStatus = document.getElementById("stock-status0");
