                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><input type="text" name="price[]" id="price<?= $i ?>" placeholder="Price" readonly></td>
                                        ...
                                        document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                                            ...
                                            xhttp.onreadystatechange = function() {
                                                if (this.readyState === 4 && this.status === 200) {
                                                    ...
                                                    document.getElementById("quantity<?= $i ?>").value = response.quantity;
                                                    document.getElementById("price<?= $i ?>").value = response.price;
                                                }
                                            };
...
/******  38a39064-307a-491e-a21d-73fe9999be70  *******/