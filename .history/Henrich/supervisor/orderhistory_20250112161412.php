                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                switch ($status) {
                                    case 'Pending':
                                        $symbol = '<i class="bx bx-time bx-sm"></i>'; // clock emoji
                                        $symbol = '&#x1F551;'; // clock emoji
                                        break;
                                    case 'Completed':
                                        $symbol = '<i class="bx bx-check bx-sm"></i>'; // check mark
                                        $symbol = '&#x2714;'; // check mark
                                        break;
                                    case 'Cancelled':
                                        $symbol = '<i class="bx bx-x bx-sm"></i>'; // cross mark
                                        $symbol = '&#x274C;'; // cross mark
                                        break;
                                    case 'Ongoing':
                                        $symbol = '<i class="bx bx-hourglass bx-sm"></i>'; // hourglass
                                        $symbol = '&#x231B;'; // hourglass
                                        break;
                                }
                                ?>
...
/******  66be3387-0028-4871-b696-1eda18d3e9c5  *******/