...
/*************  ✨ Codeium Command 🌟  *************/
                        <?php if (isset($_SESSION['userType']) && $_SESSION['userType'] === 'admin') { ?>
                            <td style="width: 100px;">
                                <a href="edit.order.php?hid=<?= $hid ?>" class="btn btn-primary btn-sm">Edit</a>
                                <a href="delete.order.php?hid=<?= $hid ?>" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        <?php } ?>
...
/******  d0184b34-95fa-4b2e-a7b3-9f8b5df1c986  *******/
