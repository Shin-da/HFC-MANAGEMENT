            ...
            <div class="">
                ...
                <script>
                    ...
                    function filterByDate() {
                        ...
                        const searchQuery = document.getElementById('general-search').value.toUpperCase();
                    ...
                    function filterByStatus(status) {
                        ...
                        rows.forEach(row => {
                            ...
                            const textMatch = row.innerText.toUpperCase().indexOf(searchQuery) > -1;
                        const noRecords = document.getElementById('no-records');
                        if (!hasRecords) {
                            noRecords.style.display = 'block';
                        } else {
                            ...
                            const dateCondition = (!startDate || orderDate >= startDate) && (!endDate || orderDate <= endDate);
                            const statusCondition = selectedStatus === 'All' || orderStatus === selectedStatus;
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        <script>
                            ...
                            if (dateCondition && statusCondition && textMatch) {
                                row.style.display = 'table-row';
                                hasRecords = true;
                            } else {
                                row.style.display = 'none';
...
/******  492ec880-d3ac-4444-b7f6-0cf8da4aa88b  *******/
