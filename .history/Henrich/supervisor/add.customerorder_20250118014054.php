                        ...
                        <table id="customerOrderTable">
                            <thead>
                                ...
                                <th>Action</th>
                                        ...
                                        if (isNaN(quantity) || isNaN(productWeight) || isNaN(productPrice)) {
                                            console.error(`add.customerorder.php:${rowIndex} quantity, productWeight or productPrice is NaN`);
                                            return;
                                        }
                            <tbody>
                                <?php
...
/******  bcb3ccb3-31f0-46a2-b540-fbd41ca820ad  *******/
