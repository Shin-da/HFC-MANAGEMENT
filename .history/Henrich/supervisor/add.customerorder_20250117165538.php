...
/*************  ✨ Codeium Command 🌟  *************/
                        ...
                        <div class="bottom-form">
                            <button type="button" class="btn btn-primary" onclick="checkInventory()">Check Inventory</button>
                        </div>
                        <div class="bottom-form">
                            <div class="buttons">
                ...
                function getProductInfo(select) {
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            var productWeightElement = document.getElementById(`productweight${rowIndex}`);
...
/******  18437c91-94ca-4c7f-8701-76c8078b8fd1  *******/
