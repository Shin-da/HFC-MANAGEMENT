...
/*************  ✨ Codeium Command 🌟  *************/
            ...
            <script>
                document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState === 4 && this.status === 200) {
                            var response = JSON.parse(this.responseText);
                            var availableQuantityInput = document.querySelector('input[name="availablequantity[]"]');
                            var stockStatusInput = document.querySelector('input[name="stock-status[]"]');
            ...
            <script>
               ...
               var rowId = <?= $i ?>;
               document.getElementById("availablequantity" + rowId).value = data.availablequantity;
               document.getElementById("stockstatus" + rowId).value = "Low stock!";
               if (data.availablequantity > 5) {
                 document.getElementById("stockstatus" + rowId).value = "In stock!";
               }
            </script>
    </section>
/******  5cef40bb-8b2a-43ce-aa90-ec8ce6ba01f5  *******/
