...
Page::addInlineScript('
    ...
    console.log("Current page:", "' . Page::get('current_page') . '");
');

// Set admin page for proper sidebar loading
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch("/HFC MANAGEMENT/Henrich/supervisor/api/sales-data.php?action=sales")
