...
/*************  ✨ Codeium Command 🌟  *************/
    ...
    if (isset($_GET['hid'])) {
        $hid = $_GET['hid'];
        $sql = "SELECT * FROM orderhistory WHERE hid = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $customerphonenumber = htmlspecialchars($row["customerphonenumber"]);
            $orderdescription = htmlspecialchars($row["orderdescription"]);
            $ordertotal = htmlspecialchars($row["ordertotal"]);
            $orderdate = htmlspecialchars($row["orderdate"]);
            $salesperson = htmlspecialchars($row["salesperson"]);
            $status = htmlspecialchars($row["status"]);
            $ordertype = htmlspecialchars($row["ordertype"]);
            ...
            <div class='order-item'>
                ...
                <div id='receipt' class='receipt-content'>
                    <div class='receipt-container'>
                        <div class='receipt-header'>
                            <h2>Receipt</h2>
                            <p>Transaction Date: $orderdate</p>
                    ...
                    <div class='invoice-container'>
                        <div class='invoice-header'>
                            ...
                            <div class='invoice-info'>
                                ...
                                <p>Due Date: " . date('Y-m-d', strtotime('+7 days')) . "</p>
                                <p>Issued by: " . htmlspecialchars($_SESSION['username']) . "</p>
                            </div>
                        </div>
                        <hr>
                        <div class='invoice-bill-to'>
                            ...
                            <ul style='list-style: none; padding: 0; margin: 0'>
                                ...
                                <li>Phone: $customerphonenumber</li>
                            </ul>
                        </div>
                        <hr>
                        <div class='invoice-salesperson'>
...
/******  38b7b1e7-a952-42f3-a514-a1910fb67afd  *******/
