<?php
ob_start();
require '/xampp/htdocs/HFC MANAGEMENT/Henrich/includes/config.php';
...
function retrieveProductData($productCode) {
  global $conn;
  $sql = "SELECT productname, productcategory, productweight, unit_price, packsperbox FROM products WHERE productcode = ?";
