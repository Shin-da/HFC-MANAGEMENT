                ...
                function addTableRow() {
                    ...
                    ['productcode', 'productname', 'quantity', 'quantityType', 'productprice', 'totalprice'].forEach((key, i) => {
                        ...
                        if (key === 'quantityType') {
                            ...
                            var newText = document.createElement('input');
                            if (key === 'productcode') {
                                newText.classList.add('select-search');
                                newText.onchange = function() {
                                    ...
                                    xhttp.onreadystatechange = function() {
                                        if (this.readyState === 4 && this.status === 200) {
                                            var response = JSON.parse(this.responseText);
                                            newText.nextElementSibling.value = response.productname;
                                            newText.nextElementSibling.nextElementSibling.value = response.productprice;
...
/******  c9a09c40-e29f-4e56-bb55-90280cf3363c  *******/
