    ...
    <section class="panel">
        ...
        <div class="container-fluid">
            ...
            <div class="">
                ...
                <p id="no-records" style="display: none; text-align: center; font-size: 16px; color: red;">No records found. Please try searching by date or status.</p>
                ...
                <table class="table" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th>Time of Order</th>
                            <th>Order Total</th>
                            <th>Status</th>turn the dropdown filter by status to buttons
                            <th>Order Date</th>
...
/******  10a77fbc-8726-464e-9f2d-972ae02b5b7f  *******/