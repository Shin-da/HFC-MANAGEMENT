...
/*************  ✨ Codeium Command 🌟  *************/
    $oidRef = &$oid;
    $customernameRef = &$customername;
    $customeraddressRef = &$customeraddress;
    $customerphonenumberRef = &$customerphonenumber;
    $orderdescriptionRef = &$orderdescription;
    $ordertotalRef = &$ordertotal;
    $orderdateRef = &$orderdate;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param("sssssssss", $oidRef, $customernameRef, $customeraddressRef, $customerphonenumberRef, $orderdescriptionRef, $ordertotalRef, $orderdateRef, $salespersonRef, $statusRef);
        $stmt->bind_param("sssssssss", $oid, $customername, $customeraddress, $customerphonenumber, $orderdescription, $ordertotal, $orderdate, $salesperson, $status[0]);
        $stmt->execute();
...
/******  ef98b5f8-68f6-4701-9f20-6f83a3219a93  *******/