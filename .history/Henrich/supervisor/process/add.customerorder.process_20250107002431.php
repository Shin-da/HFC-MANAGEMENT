...
<table class='output-table'>
    ...
    <tr>
        <td><?= is_array($oid) ? '' : $oid ?></td>
        <td><?= is_array($customername) ? '' : $customername ?></td>
        <td><?= is_array($customeraddress) ? '' : $customeraddress ?></td>
        <td><?= is_array($customerphonenumber) ? '' : $customerphonenumber ?></td>
        <td><?= is_array($orderdescription) ? '' : $orderdescription ?></td>
        <td><?= is_array($ordertotal) ? '' : $ordertotal ?></td>
        <td><?= is_array($orderdate) ? '' : $orderdate ?></td>
        <td><?= is_array($salesperson) ? '' : $salesperson ?></td>
        <td><?= is_array($status) ? '' : $status ?></td>
    </tr>
</table>
...
/******  5affb63c-63a3-462b-9753-9a26ef030248  *******/