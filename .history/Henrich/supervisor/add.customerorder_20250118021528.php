            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState === 4 && this.status === 200) {
                    try {
                        ...
                        var availableQuantityInput = document.getElementById("availablequantity0");
                        var stockStatusInput = document.getElementById("stockstatus0");
...
/******  1c71817d-3e99-439e-bf7e-d712433dc152  *******/
