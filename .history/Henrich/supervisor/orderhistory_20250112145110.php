...
function filterByDate() {
    ...
    rows.forEach(row => {
        ...
        } else {                    <div class="container filters">
                        <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                    ...
                    <table class="table" id="myTable">
                        <thead>
                            ...
                            <tr class="filter-row">
                                ...
                                <th><input type="text" placeholder="Search Time Ordered..." id="order-date-filter" onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 1)"></th>
