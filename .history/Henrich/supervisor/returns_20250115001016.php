...
<form action="returns.php" method="post">
    ...
    <textarea name="message" required></textarea><br><br>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        $query = "SELECT hid, customername, orderdescription, ordertotal FROM customerorder where status = 'Pending' or status = 'Processing'";
                        $result = mysqli_query($conn, $query);
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<tr>' .
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Return Order</button>
    <input type="submit" name="submit" value="Submit">
</form>
...
/******  fea683d0-d90f-4ceb-8e16-f69a6a247a43  *******/