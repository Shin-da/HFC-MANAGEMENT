...
/*************  ✨ Codeium Command 🌟  *************/
                function fetchProductInfo(selectElement) {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState === 4 && this.status === 200) {
                            var response = JSON.parse(this.responseText);
                            selectElement.nextElementSibling.value = response.productname;
                            selectElement.nextElementSibling.nextElementSibling.value = response.productprice;
                var productCode;
...
/******  059ba627-22f0-4204-983f-2f45aefb1fd3  *******/
            </script>
    </section>
