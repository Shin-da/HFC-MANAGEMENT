        ...
        <div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="availablequantity[]" id="quantity<?= $i ?>" placeholder="Available Quantity" readonly>
                                        </td>
            ...
            <script>
                ...
                document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                    ...
                    xhttp.open("GET", "./process/./process/check_available_quantity.php?productcode=" + productCode, true);
                    xhttp.send();
                });
            </script>
...
/******  625ece5c-e9b8-4443-ad4f-3f5f7e4cd8d9  *******/
    </section>
