                ...
                <div class="order-header-right">
                    ...
                    if (isset($_GET['hid'])) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<p class='order-id'>Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\"><i class='bx bx-copy'></i> $hid</span></p>";
                            echo "<p class='order-date'>Created on <strong>" . date('F jS', strtotime($orderdate)) . "</strong> for a <strong>$ordertype</strong> order</p>";
                        } else {
                            echo "<p class='order-id'>Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\"><i class='bx bx-copy'></i> $hid</span></p>";
                        }
                <a href="javascript:window.history.back()" id="back-toprev" style="font-size: 3rem;">
...
/******  21726f97-438b-4d33-8517-91344b373aaf  *******/
