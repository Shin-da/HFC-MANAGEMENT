...
/*************  ✨ Codeium Command 🌟  *************/
                    <th style="display: flex; justify-content: center;">
                        <button class="btn btn-secondary" onclick="filterTable(document.querySelector('#myTable tbody'), 'Pending')">Pending</button>
                        <button class="btn btn-secondary" onclick="filterTable(document.querySelector('#myTable tbody'), 'Completed')">Completed</button>
                        <button class="btn btn-secondary" onclick="filterTable(document.querySelector('#myTable tbody'), 'Cancelled')">Cancelled</button>
...
/******  32b3fc6b-c8b0-4fda-ad7a-e2327a91d293  *******/
                    <!-- Order History Table -->
