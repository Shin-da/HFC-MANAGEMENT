                        ...
                        <table id="customerOrderTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <input type="text" name="productcode[]" id="productcode<?= $i ?>" onkeyup="runGetProductStock(this, event)" placeholder="Product Code" required>
...
/******  0257e5f8-2e1b-4bd1-8f8e-57b1edf3f432  *******/
</body>
