...
<head>reformat the design of the header
  ...
  <style type="text/css">
    .card {
      ...
      height: auto;
      width: 1200px;
    }the filter by status cant filter the table because there is icon or symbol with the status inside td
    if the admin is logged in, add checkbox to select rows 
    .card-content {
      flex: 1;
      padding: 1rem;
