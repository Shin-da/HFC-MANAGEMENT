        ...
        <div>
            ...
            <script>
                ...
                document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                    ...
                    xhttp.open("GET", "check_available_quantity.php?productcode=" + productCode, true);
                    xhttp.send();
                });
            </script>
                        ...
                        xhttp.onreadystatechange = function() {
                            ...
                            if (this.readyState === 4 && this.status === 200) {
                                try {
                                    ...
                                    if (responseText.startsWith("<br /> <b>")) {
                                        alert(responseText);
                                    } else {
                                        ...
                                        if (response.error) {
                                            ...
                                            console.log("Available quantity received");
                                            var availableQuantity = response.availablequantity;
                                            var quantityInput = document.getElementById("quantity0");
                                            var stockStatus = document.getElementById("stock-status0");
                                    ...
                                    if (e instanceof SyntaxError) {
                                        ...
                                        console.log(`Error parsing response: ${e.name}: ${e.message}. Response text: ${xhttp.responseText}`);
                                    } else {
                                        console.error(`Error parsing response: ${e.name}: ${e.message}`);
                                        console.log(`Error parsing response: ${e.name}: ${e.message}`);
                                    }
                                }
...
/******  5b1249ff-f03a-4a4e-b055-674e88c1e638  *******/
    </section>
