                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="availablequantity" name="availablequantity[]" placeholder="Available Quantity" readonly>

                                        </td>
                                        <td>
                                            <input type="text" class="stock-status" name="stock-status[]" placeholder="Stock Status" readonly>
                                        </td>
                ...
                if (this.readyState === 4) {
                  ...
                  if (this.status === 200) {
                    try {
                      ...
                      var availableQuantityInputs = document.querySelectorAll(".availablequantity");
                      var stockStatusInputs = document.querySelectorAll(".stock-status");
                      availableQuantityInputs.forEach(function(input, index) {
                        input.value = response.availablequantity;
                      });
                      stockStatusInputs.forEach(function(input, index) {
                        input.value = "Low stock!";
                        if (response.availablequantity > 5) {
            ...
            <script>
                ...
                xhttp.onreadystatechange = function() {
                  if (this.readyState === 4 && this.status === 200) {
                    ...
                    document.getElementById("availablequantity" + rowId).value = response.availablequantity;
                    document.getElementById("stockstatus" + rowId).value = response.stockstatus;
                  }
                };
            </script>
    </section>
