            ...
            <div class="order-header">
                ...
                if (isset($_GET['hid'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<p>Viewing Order ID # <span onclick=\"copyToClipboard('$hid')\"><i class='bx bx-copy'></i> $hid</span> Created at: " . date('g:i A', strtotime($timeoforder)) . "</p>";
                    } else {
...
/******  a1a7c7f1-90d1-441c-a6b4-7f10ad970baa  *******/
