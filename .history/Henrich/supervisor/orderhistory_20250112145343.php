            ...
            <div class="">
                ...
                <script>
                    ...
                    <script>
                        ...
                        rows.forEach(row => {
                            const orderDate = row.querySelector('td:nth-child(4)').textContent; // assuming order date is in the 4th column
                            if ((startDate && orderDate < startDate) || (endDate && orderDate > endDate)) {
                                row.style.display = 'none';
                            rows.forEach(row => {
                                const orderDate = row.querySelector('td:nth-child(4)').textContent; // assuming order date is in the 4th column
                                if ((startDate && orderDate < script startDate) || (endDate && orderDate > endDate)) {
                                    row.style.display = 'none';
                                } else {
                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            ...
                            <div class="container filters">
                                <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                                    <button class="btn All" onclick="filterTable(document.querySelector('#myTable tbody'), 'All', 9)"> All < /button>
                                            <button class="btn Pending"onclick="filterTable(document.querySelector('#myTable tbody'), 'Pending', 9)"> Pending < /button>
                                                    <button class="btn Completed"onclick="filterTable(document.querySelector('#myTable tbody'), 'Completed', 9)"> Completed < /button>
                                                            <button class="btn Cancelled" onclick="filterTable(document.querySelector('#myTable tbody'), 'Cancelled', 9)"> Cancelled < /button>
                                                                    </div>
                                                                        </div>
                                                                                                                                                                                    ...
                                                                                                                                                                                    <
                                                                                                                                                                                        ...
                                                                                                                                                                                        <
                                                                                                                                                                                            ...
                                                                                                                                                                                            <
                                                                                                                                                                                                th>
                                                                                                                                                                                                < input type="text"
                                                                                                                                                                                                    placeholder="Search hid..."
                                                                                                                                                                                                    id="hid-filter"
                                                                                                                                                                                                    onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 0)">
                                                                                                                                                                                                    < /th>
                                                                                                                                                                                                        <
                                                                                                                                                                                                            th>
                                                                                                                                                                                                            < input type="text"
                                                                                                                                                                                                                placeholder="Search Time Ordered..."
                                                                                                                                                                                                                id="order-date-filter"
                                                                                                                                                                                                                onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 1)">
                                                                                                                                                                                                                < /th>
                                                                                                                                                                                                                    <
                                                                                                                                                                                                                        th>
                                                                                                                                                                                                                        < input type="text"
                                                                                                                                                                                                                            placeholder="Search Date Completed..."
                                                                                                                                                                                                                            id="datecompleted-filter"
                                                                                                                                                                                                                            onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 2)">
                                                                                                                                                                                                                            < /th>
                                                                                                                                                                                                                                <
                                                                                                                                                                                                                                    !-- < th>
                                                                                                                                                                                                                                    < input type="text"
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        id="oid-filter"
                                                                                                                                                                                                                                        onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 3)">
                                                                                                                                                                                                                                        < /th> --> <
                                                                                                                                                                                                                                                th>
                                                                                                                                                                                                                                                < input type="text"
                                                                                                                                                                                                                                                    placeholder="Search customername..."
                                                                                                                                                                                                                                                    id="customername-filter"
                                                                                                                                                                                                                                                    onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 4)">
                                                                                                                                                                                                                                                    < /th>
                                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                                            th>
                                                                                                                                                                                                                                                            < input type="text"
                                                                                                                                                                                                                                                                placeholder="Search customeraddress..."
                                                                                                                                                                                                                                                                id="customeraddress-filter"
                                                                                                                                                                                                                                                                onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 5)">
                                                                                                                                                                                                                                                                < /th>
                                                                                                                                                                                                                                                                    <
                                                                                                                                                                                                                                                                        !-- < th>
                                                                                                                                                                                                                                                                        < input type="text"
                                                                                                                                                                                                                                                                            placeholder="Search customerphonenumber..."
                                                                                                                                                                                                                                                                            id="customerphonenumber-filter"
                                                                                                                                                                                                                                                                            onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 6)">
                                                                                                                                                                                                                                                                            < /th> --> <
                                                                                                                                                                                                                                                                                    th>
                                                                                                                                                                                                                                                                                    < input type="text"
                                                                                                                                                                                                                                                                                        placeholder="Search orderdescription..."
                                                                                                                                                                                                                                                                                        id="orderdescription-filter"
                                                                                                                                                                                                                                                                                        onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 7)">
                                                                                                                                                                                                                                                                                        < /th>
                                                                                                                                                                                                                                                                                            <
                                                                                                                                                                                                                                                                                                th>
                                                                                                                                                                                                                                                                                                < input type="text"
                                                                                                                                                                                                                                                                                                    placeholder="Search order total..."
                                                                                                                                                                                                                                                                                                    id="order-total-filter"
                                                                                                                                                                                                                                                                                                    onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 8)">
                                                                                                                                                                                                                                                                                                    < /th>
                                                                                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                                                                                            th>
                                                                                                                                                                                                                                                                                                            < input type="text"
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                onkeyup="filterTable(document.querySelector('#myTable tbody'), this.value, 9)">
                                                                                                                                                                                                                                                                                                                < /th>
                                                                                                                                                                                                                                                                                                                    <
                                                                                                                                                                                                                                                                                                                        /tr>
                                                                                                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                class="prev"> & laquo; < /a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            < a href="?page=<?= $i ?>"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                class="page <?= $page == $i ? 'active' : '' ?>"> <?= $i ?> < /a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    </li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <?php } ?> <
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    < a href="?page=<?= $page + 1 > $totalPages ? $totalPages : $page + 1 ?>"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        class="next"> & raquo; < /a>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                /ul>
...
/******  319ce6d7-4af4-45f3-aa00-11acda4f6e43  *******/