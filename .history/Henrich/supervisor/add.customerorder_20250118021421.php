/*************  ✨ Codeium Command 🌟  *************/
                        if (response && response.availablequantity !== undefined) {
                            document.getElementById(`availablequantity${rowIndex}`).value = response.availablequantity;
                        } else {
                            document.getElementById(`availablequantity${rowIndex}`).value = '';
<?php
            ...
            <script>
                ...
                function addTableRow() {
                    ...
                    columns.forEach((key, i) => {
                        ...
                        if (response && response.stockstatus !== undefined) {
                            document.getElementById(`stockstatus${rowIndex}`).value = response.stockstatus;
                        } else {
                            document.getElementById(`stockstatus${rowIndex}`).value = '';
...
/******  ddbba276-32fa-4333-8753-9454dda92b19  *******/