...
<body>
    ...
    <section class="panel">
        ...
        ?>
        <div class="container-fluid"> <!-- Ordered Products Management -->
            ...
            <div class="table-header">
                ...
                $start = ($page - 1) * $limit;
                $items = $conn->query("SELECT DISTINCT orderid FROM orderedproduct ORDER BY timeoforder ASC LIMIT $start, $limit");
...
/******  8afa95f9-428e-4283-9d45-a7cc3d378525  *******/