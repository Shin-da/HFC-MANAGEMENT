                ...
                function getProductInfo(select) {
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            if (productNameElement && productWeightElement && productPriceElement && availableQuantityElement && stockStatusElement) {
                                productNameElement.value = response.productname;
                                productPriceElement.value = response.productprice;
                                productWeightElement.value = response.productweight;
                                availableQuantityElement.value = response.availablequantity;
                                stockStatusElement.value = response.stockstatus;
                            } else {
                                console.error(`add.customerorder.php:${rowId} HTML elements not found in the DOM`);
...
/******  723b9786-0a83-467e-aa91-647cd23e4e40  *******/