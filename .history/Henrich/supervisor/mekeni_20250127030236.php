...
<?php
function calculateSuggestedOrder($current_stock, $avg_daily_sales, $pieces_per_box)
{
    ...
    // Round up to nearest box quantity if pieces_per_box is set
    if ($pieces_per_box > 0) {
        $suggested_order = ceil($suggested_order / $pieces_per_box) * $pieces_per_box;
    }
