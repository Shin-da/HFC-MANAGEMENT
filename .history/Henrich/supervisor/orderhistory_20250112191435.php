...
if ($_SESSION['user_type'] == 'admin') {
    ...
    echo '<a href="add.customerorder.php" class="btn btn-primary">Add Customer Order</a>';
    echo '<a href="orderhistorydetail.php" class="btn btn-secondary">View Order History</a>';
    echo '</div>';
} else {
    echo '<div class="actions">';
    echo '<a href="orderhistorydetail.php" class="btn btn-secondary">View Order History</a>';
...
/******  21c1a9b4-5126-4f83-8b84-488f7f0fb80e  *******/