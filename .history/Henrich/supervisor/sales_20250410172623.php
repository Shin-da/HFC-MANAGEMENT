    ...
    <div class="charts-grid">
        <div class="chart-card">
            ...
            <div class="chart-container">
                ...
                <div id="myChart-error" class="chart-error" style="display:none;color:red;padding:10px;">Chart failed to load</div>
            </div>
        </div>
        <div class="chart-card">
            ...
            <div class="chart-container">
                ...
                <div id="polarAreaChart-error" class="chart-error" style="display:none;color:red;padding:10px;">Chart failed to load</div>
            </div>
        </div>
        <div class="chart-card">
            ...
            <div class="chart-container">
                ...
                <div id="categoryChart-error" class="chart-error" style="display:none;color:red;padding:10px;">Chart failed to load</div>
            </div>
        </div>
        <div class="chart-card">
            ...
            <div class="chart-container">
                ...
                <div id="seasonalChart-error" class="chart-error" style="display:none;color:red;padding:10px;">Chart failed to load</div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        // DIRECT FALLBACK CHARTS - If our main initialization fails, try this direct approach
        setTimeout(() => {
            if (document.getElementById('myChart-error').style.display === 'none') {
                console.log('Main charts loaded successfully');
                return;
            }
            
            console.log('Attempting fallback direct chart initialization...');
            ...
            if (salesCtx) {
                try {
                    new Chart(salesCtx, {
                        type: 'bar',
                        data: {
                            labels: <?= json_encode($orderdate_values) ?>,
                            datasets: [{
                                label: 'Sales Trends',
                                data: <?= json_encode($ordertotal_values) ?>,
                                backgroundColor: 'rgba(75, 192, 192, 0.5)',
                                borderColor: 'rgba(75, 192, 192, 1)',
                                borderWidth: 1
                            }]
                    ...
                    console.log('Direct fallback sales chart created');
                } catch (e) {
                    console.error('Failed to create fallback sales chart:', e);
                    document.getElementById('myChart-error').style.display = 'block';
                }
            }
            ...
            if (categoryCtx) {
                try {
                    ...
                    console.log('Direct fallback category chart created');
                } catch (e) {
                    console.error('Failed to create fallback category chart:', e);
                    document.getElementById('categoryChart-error').style.display = 'block';
                }
            }
        }, 1000); // Wait 1 second to see if main charts loaded
    } catch (error) {
