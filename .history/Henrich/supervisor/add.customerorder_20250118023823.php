                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <input type="number" name="availablequantity" class="availablequantity" placeholder="Available Quantity" readonly>

                                        </td>
                                        <td><input type="text" name="stockstatus" class="stockstatus" placeholder="Stock Status" readonly></td>
                ...
                document.getElementById("productcode<?= $i ?>").addEventListener("change", function() {
                    ...
                    xhttp.onreadystatechange = function() {
                        if (this.readyState === 4 && this.status === 200) {
                            ...
                            var availableQuantityInput = document.getElementById(`availablequantity${productCode}`);
                            var stockStatusInput = document.getElementById(`stockstatus${productCode}`);
...
/******  08d7b4fc-7674-4551-9fd7-ee1944bf1168  *******/