            ...
            <script>
                function addTableRow() {
                    ...
                    ['productcode', 'productname', 'quantity', 'quantityType', 'productprice', 'totalprice'].forEach((key, i) => {
                        ...
                        if (key === 'productcode') {
                            ...
                            newText.placeholder = key.charAt(0).toUpperCase() + key.slice(1);
                            if (key === 'quantity') {
                                newText.addEventListener('change', function() {
                                    calculateTotal(newText);
                                });
                            }
                            newCell.appendChild(newText);
                        }
                ...
                function getProductInfo(select) {
                    ...
                    xmlhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            var response = JSON.parse(this.responseText);
                            var productNameElement = document.getElementById("productname" + rowId) || document.getElementById("productname" + 0);
                            var productPriceElement = document.getElementById("productprice" + rowId) || document.getElementById("productprice" + 0);
...
/******  a46acd89-3d32-478a-bb84-d94f3e390766  *******/
    </section>
