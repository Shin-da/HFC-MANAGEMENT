        ...
        <div class="container-fluid">
            ...
            <div class="table-header">
                <div style=" display: flex; justify-content: space-around; align-items: center; width: 100%;">
                    <div class="icons">
                        <a href="javascript:location.reload()" class="icon-link"><?php echo getIcon('refresh'); ?></a>
                        <a href="#" class="icon-link" id="export"><?php echo getIcon('download'); ?></a>
                        <a href="add.customerorder.php" class="icon-link"><?php echo getIcon('plus'); ?> Add New Order </a>
                ...
                <div class="icons">
                    ...
                    <a href="add.customerorder.php" class="icon-link"><i class="bx bx-plus"></i> Add New Order </a>
                </div>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                onclick="location.href='orderhistorydetail.php?hid=<?= $hid ?>'">
                                    <td style=" background-color:transparent; text-align: center" ><?= $symbol ?></td>
                                    <td><?= $hid ?></td>
                                    <td><?= $timeoforder ?></td>
            ...
            <div class="">
                ...
                <script>
                    ...
                    function getIcon(type) {
                        switch(type) {
                            case 'refresh':
                                return '<i class="bx bx-refresh"></i>';
                            case 'download':
                                return '<i class="bx bx-download"></i>';
                            case 'plus':
                                return '<i class="bx bx-plus"></i>';
                            case 'time':
                                return '<i class="bx bx-time bx-fw"></i>';
                            case 'check':
                                return '<i class="bx bx-check bx-fw"></i>';
                            case 'cross':
                                return '<i class="bx bx-x bx-fw"></i>';
                            case 'hourglass':
                                return '<i class="bx bx-hourglass bx-fw"></i>';
                            default:
                                return '';
                        }
                    }
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                switch ($status) {
                                    case 'Pending':
                                        ...
                                        break;
                                    case 'Completed':
                                        $symbol = getIcon('check');
                                        break;
                                    case 'Cancelled':
                                        $symbol = getIcon('cross');
                                        break;
                                    case 'Ongoing':
                                        $symbol = getIcon('hourglass');
                                        break;
                                }
                                ?>
                                <tr 
...
/******  1f232007-2b20-4826-ae48-31fa01df5b2a  *******/