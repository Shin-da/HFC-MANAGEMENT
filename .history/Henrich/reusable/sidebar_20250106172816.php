    ...
    <div id="leftside-navigation" class="nano">
        <div class="nano-content">
            <ul class="nano-content">
                ...
                <li class="header ">
                    <a href="javascript:void(0)" class="disabled-link"><img src="../resources/images/hfclogo.png" alt="henrich logo"></i><span>Henrich Management</span></a>
                </li>
                ...
                <li class="<?php if ($current_page == 'index') echo 'active'; ?>"><a href="index.php"><i class="bx bx-home-alt icon"></i><span>Dashboard</span></a></li>
                ...
                <li class="sub-menu <?php if ($current_page == 'sales' || $current_page == 'orders' || $current_page == 'orderhistory'    || $current_page == 'returns') echo 'active'; ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php if ($current_page == 'orders') echo 'active'; ?>"><a href="orders.php"> <i class="bx bxs-right-arrow sub-arrow<?php if ($current_page == 'orders') echo 'active'; ?>"></i> Orders</a></li>
                        <li class="<?php if ($current_page == 'orderhistory') echo 'active'; ?>"><a href="orderhistory.php"> <i class="bx bxs-right-arrow sub-arrow<?php if ($current_page == 'orderhistory') echo 'active'; ?> "></i> Order History</a></li>
                ...
                <li class="<?php if ($current_page == 'customer') echo 'active'; ?>"><a href="customerorder.php"><i class="bx bx-user icon"></i><span>Customer </span></a></li>
