            ...
            <ul class="nano-content">
                ...
                <li class="sub-menu <?php if ($current_page == 'sales' || $current_page == 'orderedproducts' || $current_page == 'orderhistory'    || $current_page == 'returns') echo 'active'; ?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php if ($current_page == 'Customerorder') echo 'active'; ?>"><a href="orderhistory.php"> <i class="bx bxs-right-arrow sub-arrow<?php if ($current_page == 'orderhistory') echo 'active'; ?> "></i> Order History</a></li>
