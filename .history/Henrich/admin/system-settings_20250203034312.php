...
Page::setBodyClass('admin-settings');
Page::setCurrentPage('system-settings');

// Add required styles
Page::addStyle('../assets/css/admin.css');
Page::addStyle('../assets/css/settings.css');
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="alert alert-warning">
                ...
                <a href="../database/create_settings_table.php">Create Settings Table</a>
            </div>
        <?php endif; ?>
    </div>
