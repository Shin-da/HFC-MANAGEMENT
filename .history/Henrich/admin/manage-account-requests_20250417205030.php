                    ...
                    <tbody id="requestTableBody">
                        ...
                        try {
                            ...
                            if ($tableCheck->rowCount() == 0) {
                                echo "<tr><td colspan='8'>The account_requests table does not exist. Please run the database setup script.</td></tr>";
                            } else {
                                ...
                                if (count($requests) > 0) {
                                    foreach ($requests as $row) {
                                        ...
                                        echo "<tr>
                                            ...
                                            <td><span class='badge bg-{$statusClass} text-white'>" . htmlspecialchars($row['status']) . "</span></td>
                                    ...
                                    echo "<tr><td colspan='8'>No account requests found</td></tr>";
                                }
                            }
                        } catch (PDOException $e) {
                            error_log("Error in manage-account-requests.php: " . $e->getMessage());
                            echo "<tr><td colspan='8'>Error: Unable to fetch account requests. Please check the error log.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
