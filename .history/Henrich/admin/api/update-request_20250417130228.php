...
try {
    ...
    // Log the action
    logAdminAction("Updated request ID: $requestId status to $status");

    // Send notification to user
    // sendRequestStatusNotification($request, $status); // Temporarily commented out to test if mail() causes 500 error
