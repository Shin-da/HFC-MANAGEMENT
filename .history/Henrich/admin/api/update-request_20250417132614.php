<?php
error_log("--- update-request.php ENTRY POINT ---"); // Log immediately upon entry

// Set error logging location to Windows Temp directory
ini_set('log_errors', 1);
ini_set('error_log', 'C:/Windows/Temp/hfc_debug.log'); // Use Temp Dir
