...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <ul>
                    <li><a href="#" data-aos="fade-right">Home</a></li>
                    <li><a href="#" data-aos="fade-right" data-aos-delay="100">About</a></li>
                    <li><a href="#" data-aos="fade-right" data-aos-delay="200">Contact</a></li>
                </ul>
            </nav>
        </header>
        <main>
            <section class="hero">
                <h1 data-aos="zoom-in">Henrich Food Corporation</h1>
                <p data-aos="fade-up" data-aos-delay="100">Welcome to our website! We're a food truck company that serves delicious food to the people of Metro Manila.</p>
                <a href="../Online Shop/app.php" class="shop-now" data-aos="fade-up" data-aos-delay="200">Shop Now</a>
            </section>
            ...
            <section class="product-section">
                ...
                <div class="products">
                    <?php foreach ($categories as $categoryName => $products) : ?>
                        <div class="category" data-aos="fade-up" data-aos-delay="<?php echo array_search($categoryName, array_keys($categories)) * 100 ?>">
                            ...
                            <div class="carousel" id="<?php echo $categoryName; ?>">
                                <div class="carousel-inner">
                                    <?php foreach (array_slice($products, 0, 4) as $index => $product) : ?>
                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : '' ?>" data-aos="fade-up" data-aos-delay="<?php echo $index * 100 ?>">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="./Henrich/resources/images/<?php echo $product['productimage'] ?>" alt="<?php echo $product['productname'] ?>" class="product-image">
    ...
    <main>
        ...
        <section class="product-section">
            ...
            <div class="products">
                            ...
                            <div class="carousel-inner">
                                <?php foreach (array_slice($products, 0, 4) as $index => $product) : ?>
                                    ...
                                    <?php foreach (array_slice($products, 4) as $product) : ?>
                                        <div class="carousel-item" data-aos="fade-up" data-aos-delay="<?php echo (array_search($categoryName, array_keys($categories)) * 100) + ($index * 100) ?>">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="./Henrich/resources/images/<?php echo $product['productimage'] ?>" alt="<?php echo $product['productname'] ?>" class="product-image">
                                                    <div class="product-info">
                ...
                <a class="see-more" onclick="toggleSeeMore()" data-aos="fade-up" data-aos-delay="200">See More</a>
            </section>
        </main>
                    </div>
                <?php endforeach; ?>
...
/******  1a3e8dc3-f99c-4fea-8309-12d8bafe063f  *******/
    <footer>
