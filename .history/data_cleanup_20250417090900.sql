-- Data Cleanup Script for Henrich Food Corps Database
...
-- Create temporary tables to identify duplicates
...
-- Keep one record for each user_id and remove duplicates
