...
try {
    ...
    $sql = "SELECT productcode, productname, productcategory, productweight, unit_price as productprice, productimage, piecesperbox FROM products WHERE productstatus = 'Active'";
