<?php
require '<div class="">/Henrich/database/dbconnect.php';
...
<head>
    ...
    <style>
        * {
        ...
        .hero {
            background-image: linear-gradient(to bottom, rgba(51,51,51,0.8), rgba(68,68,68,0.8)), url('./resources/images/warehouse.png');
