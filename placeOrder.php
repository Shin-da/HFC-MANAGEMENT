...
function confirmOrder($conn, $accountId, $customerName, $customerAddress, $customerPhone, $orderDescription, $orderTotal) {
    ...
    $orderQuery = "INSERT INTO customerorder (customername, customeraddress, customerphonenumber, orderdescription, ordertotal, orderdate, status, salesperson, customerid) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
